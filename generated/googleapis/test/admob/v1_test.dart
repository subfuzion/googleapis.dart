...
core.List<api.AdUnit> buildUnnamed7602() {
  var o = <api.AdUnit>[];
  o.add(buildAdUnit());
  o.add(buildAdUnit());
  return o;
...
void checkUnnamed7602(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.App> buildUnnamed7603() {
  var o = <api.App>[];
  o.add(buildApp());
  o.add(buildApp());
  return o;
...
void checkUnnamed7603(core.List<api.App> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PublisherAccount> buildUnnamed7604() {
...
void checkUnnamed7604(core.List<api.PublisherAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MediationReportSpecDimensionFilter> buildUnnamed7605() {
...
void checkUnnamed7605(core.List<api.MediationReportSpecDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed7606() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed7606(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.MediationReportSpecSortCondition> buildUnnamed7608() {
...
void checkUnnamed7608(core.List<api.MediationReportSpecSortCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MediationReportSpec buildMediationReportSpec() {
  ...
  if (buildCounterMediationReportSpec < 3) {
    ...
    o.dimensionFilters = buildUnnamed7605();
    o.dimensions = buildUnnamed7606();
    o.localizationSettings = buildLocalizationSettings();
    o.maxReportRows = 42;
    o.metrics = buildUnnamed7607();
    o.sortConditions = buildUnnamed7608();
    o.timeZone = 'foo';
  }
  buildCounterMediationReportSpec--;
  return o;
...
void checkMediationReportSpec(api.MediationReportSpec o) {
  ...
  if (buildCounterMediationReportSpec < 3) {
    ...
    checkUnnamed7605(o.dimensionFilters!);
    checkUnnamed7606(o.dimensions!);
    ...
    checkUnnamed7607(o.metrics!);
    checkUnnamed7608(o.sortConditions!);
    unittest.expect(
      o.timeZone!,
      unittest.equals('foo'),
    );
...
core.List<api.NetworkReportSpecDimensionFilter> buildUnnamed7609() {
...
void checkUnnamed7609(core.List<api.NetworkReportSpecDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NetworkReportSpecSortCondition> buildUnnamed7612() {
...
void checkUnnamed7612(core.List<api.NetworkReportSpecSortCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NetworkReportSpec buildNetworkReportSpec() {
  ...
  if (buildCounterNetworkReportSpec < 3) {
    o.dateRange = buildDateRange();
    o.dimensionFilters = buildUnnamed7609();
    o.dimensions = buildUnnamed7610();
    o.localizationSettings = buildLocalizationSettings();
    o.maxReportRows = 42;
    o.metrics = buildUnnamed7611();
    o.sortConditions = buildUnnamed7612();
    o.timeZone = 'foo';
  }
  buildCounterNetworkReportSpec--;
  return o;
...
void checkNetworkReportSpec(api.NetworkReportSpec o) {
  ...
  if (buildCounterNetworkReportSpec < 3) {
    checkDateRange(o.dateRange! as api.DateRange);
    checkUnnamed7609(o.dimensionFilters!);
    checkUnnamed7610(o.dimensions!);
    checkLocalizationSettings(
        o.localizationSettings! as api.LocalizationSettings);
    unittest.expect(
      o.maxReportRows!,
    ...
    checkUnnamed7611(o.metrics!);
    checkUnnamed7612(o.sortConditions!);
    unittest.expect(
      o.timeZone!,
      unittest.equals('foo'),
    );
...
core.List<api.ReportWarning> buildUnnamed7613() {
...
void checkUnnamed7613(core.List<api.ReportWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ReportRowDimensionValue> buildUnnamed7614() {
...
void checkUnnamed7614(core.Map<core.String, api.ReportRowDimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ReportRowMetricValue> buildUnnamed7615() {
...
void checkUnnamed7615(core.Map<core.String, api.ReportRowMetricValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReportRow buildReportRow() {
  ...
  if (buildCounterReportRow < 3) {
    o.dimensionValues = buildUnnamed7614();
    o.metricValues = buildUnnamed7615();
  }
  buildCounterReportRow--;
  return o;
}
...
void checkReportRow(api.ReportRow o) {
  buildCounterReportRow++;
  if (buildCounterReportRow < 3) {
    checkUnnamed7614(o.dimensionValues!);
    checkUnnamed7615(o.metricValues!);
  }
  buildCounterReportRow--;
}
