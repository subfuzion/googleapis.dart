...
core.List<api.DeviceCredential> buildUnnamed3248() {
...
void checkUnnamed3248(core.List<api.DeviceCredential> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Device buildDevice() {
  ...
  if (buildCounterDevice < 3) {
    ...
    o.credentials = buildUnnamed3248();
...
void checkDevice(api.Device o) {
  ...
  if (buildCounterDevice < 3) {
    ...
    checkUnnamed3248(o.credentials!);
...
core.List<api.RegistryCredential> buildUnnamed3250() {
...
void checkUnnamed3250(core.List<api.RegistryCredential> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRegistryCredential(o[0] as api.RegistryCredential);
  checkRegistryCredential(o[1] as api.RegistryCredential);
}

core.List<api.EventNotificationConfig> buildUnnamed3251() {
...
void checkUnnamed3251(core.List<api.EventNotificationConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DeviceRegistry buildDeviceRegistry() {
  ...
  if (buildCounterDeviceRegistry < 3) {
    o.credentials = buildUnnamed3250();
    o.eventNotificationConfigs = buildUnnamed3251();
...
void checkDeviceRegistry(api.DeviceRegistry o) {
  buildCounterDeviceRegistry++;
  if (buildCounterDeviceRegistry < 3) {
    checkUnnamed3250(o.credentials!);
    checkUnnamed3251(o.eventNotificationConfigs!);
...
core.List<api.DeviceConfig> buildUnnamed3252() {
  var o = <api.DeviceConfig>[];
...
void checkUnnamed3252(core.List<api.DeviceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDeviceConfigVersionsResponse buildListDeviceConfigVersionsResponse() {
  ...
  if (buildCounterListDeviceConfigVersionsResponse < 3) {
    o.deviceConfigs = buildUnnamed3252();
  }
  buildCounterListDeviceConfigVersionsResponse--;
  return o;
}
...
void checkListDeviceConfigVersionsResponse(
  ...
  buildCounterListDeviceConfigVersionsResponse++;
  if (buildCounterListDeviceConfigVersionsResponse < 3) {
    checkUnnamed3252(o.deviceConfigs!);
  }
  buildCounterListDeviceConfigVersionsResponse--;
}

core.List<api.DeviceRegistry> buildUnnamed3253() {
  var o = <api.DeviceRegistry>[];
...
void checkUnnamed3253(core.List<api.DeviceRegistry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDeviceRegistriesResponse buildListDeviceRegistriesResponse() {
  ...
  if (buildCounterListDeviceRegistriesResponse < 3) {
    o.deviceRegistries = buildUnnamed3253();
    o.nextPageToken = 'foo';
  }
  buildCounterListDeviceRegistriesResponse--;
  return o;
...
void checkListDeviceRegistriesResponse(api.ListDeviceRegistriesResponse o) {
  buildCounterListDeviceRegistriesResponse++;
  if (buildCounterListDeviceRegistriesResponse < 3) {
    checkUnnamed3253(o.deviceRegistries!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.DeviceState> buildUnnamed3254() {
  var o = <api.DeviceState>[];
...
void checkUnnamed3254(core.List<api.DeviceState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDeviceStatesResponse buildListDeviceStatesResponse() {
  ...
  if (buildCounterListDeviceStatesResponse < 3) {
    o.deviceStates = buildUnnamed3254();
  }
  buildCounterListDeviceStatesResponse--;
  return o;
}
...
void checkListDeviceStatesResponse(api.ListDeviceStatesResponse o) {
  buildCounterListDeviceStatesResponse++;
  if (buildCounterListDeviceStatesResponse < 3) {
    checkUnnamed3254(o.deviceStates!);
  }
  buildCounterListDeviceStatesResponse--;
}

core.List<api.Device> buildUnnamed3255() {
  var o = <api.Device>[];
  o.add(buildDevice());
  o.add(buildDevice());
  return o;
...
void checkUnnamed3255(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Binding> buildUnnamed3256() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed3256(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3258() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed3257());
  o.add(buildUnnamed3257());
  return o;
}

void checkUnnamed3258(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3257(o[0]);
  checkUnnamed3257(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsRegistriesDevicesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.CloudIotApi(mock).projects.locations.registries.devices;
      var arg_parent = 'foo';
      var arg_deviceIds = buildUnnamed3261();
      var arg_deviceNumIds = buildUnnamed3262();
      var arg_fieldMask = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsRegistriesGroupsDevicesResource',
    ...
    unittest.test('method--list', () async {
      ...
      var arg_parent = 'foo';
      var arg_deviceIds = buildUnnamed3263();
      var arg_deviceNumIds = buildUnnamed3264();
      var arg_fieldMask = 'foo';
      var arg_gatewayListOptions_associationsDeviceId = 'foo';
      var arg_gatewayListOptions_associationsGatewayId = 'foo';
      var arg_gatewayListOptions_gatewayType = 'foo';
