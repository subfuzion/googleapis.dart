...
core.List<api.PartitionCursor> buildUnnamed7523() {
...
void checkUnnamed7523(core.List<api.PartitionCursor> o) {
...
api.ListPartitionCursorsResponse buildListPartitionCursorsResponse() {
  ...
  if (buildCounterListPartitionCursorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.partitionCursors = buildUnnamed7523();
  }
  buildCounterListPartitionCursorsResponse--;
  return o;
}
...
void checkListPartitionCursorsResponse(api.ListPartitionCursorsResponse o) {
  ...
  if (buildCounterListPartitionCursorsResponse < 3) {
    ...
    checkUnnamed7523(o.partitionCursors!);
  }
  buildCounterListPartitionCursorsResponse--;
}

core.List<api.Subscription> buildUnnamed7524() {
...
void checkUnnamed7524(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSubscriptionsResponse buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.subscriptions = buildUnnamed7524();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
void checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    ...
    checkUnnamed7524(o.subscriptions!);
  }
  buildCounterListSubscriptionsResponse--;
}
...
core.List<api.Topic> buildUnnamed7526() {
  var o = <api.Topic>[];
  o.add(buildTopic());
  o.add(buildTopic());
  return o;
...
void checkUnnamed7526(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
