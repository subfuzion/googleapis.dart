...
core.List<api.Token> buildUnnamed3006() {
  var o = <api.Token>[];
  o.add(buildToken());
  o.add(buildToken());
  return o;
...
void checkUnnamed3006(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ClassificationCategory> buildUnnamed3007() {
...
void checkUnnamed3007(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Entity> buildUnnamed3008() {
  var o = <api.Entity>[];
  o.add(buildEntity());
  o.add(buildEntity());
  return o;
...
void checkUnnamed3008(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0] as api.Entity);
  checkEntity(o[1] as api.Entity);
}

core.List<api.Sentence> buildUnnamed3009() {
  var o = <api.Sentence>[];
  o.add(buildSentence());
  o.add(buildSentence());
  return o;
...
void checkUnnamed3009(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0] as api.Sentence);
  checkSentence(o[1] as api.Sentence);
}

core.List<api.Token> buildUnnamed3010() {
  var o = <api.Token>[];
  o.add(buildToken());
  o.add(buildToken());
  return o;
...
void checkUnnamed3010(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0] as api.Token);
  checkToken(o[1] as api.Token);
}
...
api.AnnotateTextResponse buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.categories = buildUnnamed3007();
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed3008();
    o.language = 'foo';
    o.sentences = buildUnnamed3009();
    o.tokens = buildUnnamed3010();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
void checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  buildCounterAnnotateTextResponse++;
  if (buildCounterAnnotateTextResponse < 3) {
    checkUnnamed3007(o.categories!);
    checkSentiment(o.documentSentiment! as api.Sentiment);
    checkUnnamed3008(o.entities!);
    unittest.expect(
      o.language!,
      unittest.equals('foo'),
    );
    checkUnnamed3009(o.sentences!);
    checkUnnamed3010(o.tokens!);
  }
  buildCounterAnnotateTextResponse--;
}
...
core.List<api.ClassificationCategory> buildUnnamed3011() {
  var o = <api.ClassificationCategory>[];
  o.add(buildClassificationCategory());
  o.add(buildClassificationCategory());
  return o;
...
void checkUnnamed3011(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0] as api.ClassificationCategory);
  checkClassificationCategory(o[1] as api.ClassificationCategory);
}
...
core.List<api.EntityMention> buildUnnamed3012() {
...
void checkUnnamed3012(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Entity buildEntity() {
  ...
  if (buildCounterEntity < 3) {
    o.mentions = buildUnnamed3012();
    o.metadata = buildUnnamed3013();
    o.name = 'foo';
    o.salience = 42.0;
...
void checkEntity(api.Entity o) {
  buildCounterEntity++;
  if (buildCounterEntity < 3) {
    checkUnnamed3012(o.mentions!);
    checkUnnamed3013(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed3014() {
...
void checkUnnamed3014(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3015() {
...
void checkUnnamed3015(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
