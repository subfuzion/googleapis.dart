...
void checkBatchDeletePhotosRequest(api.BatchDeletePhotosRequest o) {
  buildCounterBatchDeletePhotosRequest++;
  if (buildCounterBatchDeletePhotosRequest < 3) {
    checkUnnamed7617(o.photoIds!);
  }
  buildCounterBatchDeletePhotosRequest--;
}

core.List<api.Status> buildUnnamed7618() {
  var o = <api.Status>[];
  o.add(buildStatus());
  o.add(buildStatus());
  return o;
...
void checkUnnamed7618(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UpdatePhotoRequest> buildUnnamed7620() {
...
void checkUnnamed7620(core.List<api.UpdatePhotoRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BatchUpdatePhotosRequest buildBatchUpdatePhotosRequest() {
  ...
  if (buildCounterBatchUpdatePhotosRequest < 3) {
    o.updatePhotoRequests = buildUnnamed7620();
  }
  buildCounterBatchUpdatePhotosRequest--;
  return o;
}
...
void checkBatchUpdatePhotosRequest(api.BatchUpdatePhotosRequest o) {
  buildCounterBatchUpdatePhotosRequest++;
  if (buildCounterBatchUpdatePhotosRequest < 3) {
    checkUnnamed7620(o.updatePhotoRequests!);
  }
  buildCounterBatchUpdatePhotosRequest--;
}

core.List<api.PhotoResponse> buildUnnamed7621() {
  var o = <api.PhotoResponse>[];
  o.add(buildPhotoResponse());
  o.add(buildPhotoResponse());
  return o;
...
void checkUnnamed7621(core.List<api.PhotoResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhotoResponse(o[0] as api.PhotoResponse);
  checkPhotoResponse(o[1] as api.PhotoResponse);
}
...
core.List<api.Photo> buildUnnamed7622() {
  var o = <api.Photo>[];
  o.add(buildPhoto());
  o.add(buildPhoto());
  return o;
...
void checkUnnamed7622(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListPhotosResponse(api.ListPhotosResponse o) {
  ...
  if (buildCounterListPhotosResponse < 3) {
    ...
    checkUnnamed7622(o.photos!);
  }
  buildCounterListPhotosResponse--;
}

core.Map<core.String, core.Object> buildUnnamed7623() {
...
void checkUnnamed7623(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed7623();
    o.name = 'foo';
    o.response = buildUnnamed7624();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed7623(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed7624(o.response!);
  }
  buildCounterOperation--;
}

core.List<api.Connection> buildUnnamed7625() {
  var o = <api.Connection>[];
...
void checkUnnamed7625(core.List<api.Connection> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConnection(o[0] as api.Connection);
  checkConnection(o[1] as api.Connection);
}

core.List<api.Place> buildUnnamed7626() {
  var o = <api.Place>[];
  o.add(buildPlace());
  o.add(buildPlace());
  return o;
...
void checkUnnamed7626(core.List<api.Place> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Photo buildPhoto() {
  ...
  if (buildCounterPhoto < 3) {
    o.captureTime = 'foo';
    o.connections = buildUnnamed7625();
    o.downloadUrl = 'foo';
    o.mapsPublishStatus = 'foo';
    o.photoId = buildPhotoId();
    o.places = buildUnnamed7626();
    o.pose = buildPose();
    o.shareLink = 'foo';
    o.thumbnailUrl = 'foo';
...
void checkPhoto(api.Photo o) {
  ...
  if (buildCounterPhoto < 3) {
    ...
    checkUnnamed7625(o.connections!);
    unittest.expect(
      o.downloadUrl!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed7627() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7627(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7628() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7627());
  o.add(buildUnnamed7627());
  return o;
}

void checkUnnamed7628(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7627(o[0]);
  checkUnnamed7627(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-PhotosResource', () {
    ...
    unittest.test('method--batchGet', () async {
      ...
      var res = api.StreetViewPublishApi(mock).photos;
      var arg_languageCode = 'foo';
      var arg_photoIds = buildUnnamed7629();
      var arg_view = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
