...
core.List<api.ExpressionReport> buildUnnamed7454() {
...
void checkUnnamed7455(core.List<api.ValueCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed7456() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7456(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Arg> buildUnnamed7457() {
  var o = <api.Arg>[];
  o.add(buildArg());
  o.add(buildArg());
  return o;
...
void checkUnnamed7457(core.List<api.Arg> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Release> buildUnnamed7458() {
  var o = <api.Release>[];
  o.add(buildRelease());
  o.add(buildRelease());
  return o;
...
void checkUnnamed7458(core.List<api.Release> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListReleasesResponse(api.ListReleasesResponse o) {
  ...
  if (buildCounterListReleasesResponse < 3) {
    ...
    checkUnnamed7458(o.releases!);
  }
  buildCounterListReleasesResponse--;
}

core.List<api.Ruleset> buildUnnamed7459() {
  var o = <api.Ruleset>[];
  o.add(buildRuleset());
  o.add(buildRuleset());
  return o;
...
void checkUnnamed7459(core.List<api.Ruleset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.File> buildUnnamed7461() {
  var o = <api.File>[];
  o.add(buildFile());
  o.add(buildFile());
  return o;
...
void checkUnnamed7461(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.FunctionMock> buildUnnamed7462() {
  var o = <api.FunctionMock>[];
...
void checkUnnamed7462(core.List<api.FunctionMock> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TestCase buildTestCase() {
  ...
  if (buildCounterTestCase < 3) {
    ...
    o.functionMocks = buildUnnamed7462();
    o.pathEncoding = 'foo';
    o.request = {
      'list': [1, 2, 3],
      'bool': true,
...
void checkTestCase(api.TestCase o) {
  ...
  if (buildCounterTestCase < 3) {
    ...
    checkUnnamed7462(o.functionMocks!);
    unittest.expect(
      o.pathEncoding!,
      unittest.equals('foo'),
    );
...
core.List<api.ExpressionReport> buildUnnamed7464() {
  var o = <api.ExpressionReport>[];
  o.add(buildExpressionReport());
  o.add(buildExpressionReport());
  return o;
...
void checkUnnamed7464(core.List<api.ExpressionReport> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExpressionReport(o[0] as api.ExpressionReport);
  checkExpressionReport(o[1] as api.ExpressionReport);
}

core.List<api.FunctionCall> buildUnnamed7465() {
  var o = <api.FunctionCall>[];
...
void checkUnnamed7465(core.List<api.FunctionCall> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFunctionCall(o[0] as api.FunctionCall);
  checkFunctionCall(o[1] as api.FunctionCall);
}

core.List<api.VisitedExpression> buildUnnamed7466() {
...
void checkUnnamed7466(core.List<api.VisitedExpression> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TestResult buildTestResult() {
  ...
  if (buildCounterTestResult < 3) {
    o.debugMessages = buildUnnamed7463();
    o.errorPosition = buildSourcePosition();
    o.expressionReports = buildUnnamed7464();
    o.functionCalls = buildUnnamed7465();
    o.state = 'foo';
    o.visitedExpressions = buildUnnamed7466();
  }
  buildCounterTestResult--;
  return o;
}
...
void checkTestResult(api.TestResult o) {
  buildCounterTestResult++;
  if (buildCounterTestResult < 3) {
    checkUnnamed7463(o.debugMessages!);
    checkSourcePosition(o.errorPosition! as api.SourcePosition);
    checkUnnamed7464(o.expressionReports!);
    checkUnnamed7465(o.functionCalls!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
    checkUnnamed7466(o.visitedExpressions!);
  }
  buildCounterTestResult--;
}
...
core.List<api.Issue> buildUnnamed7467() {
  var o = <api.Issue>[];
  o.add(buildIssue());
  o.add(buildIssue());
  return o;
...
void checkUnnamed7467(core.List<api.Issue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIssue(o[0] as api.Issue);
  checkIssue(o[1] as api.Issue);
}

core.List<api.TestResult> buildUnnamed7468() {
  var o = <api.TestResult>[];
...
void checkUnnamed7468(core.List<api.TestResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TestRulesetResponse buildTestRulesetResponse() {
  ...
  if (buildCounterTestRulesetResponse < 3) {
    o.issues = buildUnnamed7467();
    o.testResults = buildUnnamed7468();
  }
  buildCounterTestRulesetResponse--;
  return o;
}
...
void checkTestRulesetResponse(api.TestRulesetResponse o) {
  buildCounterTestRulesetResponse++;
  if (buildCounterTestRulesetResponse < 3) {
    checkUnnamed7467(o.issues!);
    checkUnnamed7468(o.testResults!);
  }
  buildCounterTestRulesetResponse--;
}

core.List<api.TestCase> buildUnnamed7469() {
  var o = <api.TestCase>[];
  o.add(buildTestCase());
  o.add(buildTestCase());
  return o;
...
void checkUnnamed7469(core.List<api.TestCase> o) {
  unittest.expect(o, unittest.hasLength(2));
