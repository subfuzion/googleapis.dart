...
core.List<api.TaskLinks> buildUnnamed7734() {
  var o = <api.TaskLinks>[];
...
void checkUnnamed7734(core.List<api.TaskLinks> o) {
...
core.List<api.TaskList> buildUnnamed7735() {
  var o = <api.TaskList>[];
  o.add(buildTaskList());
  o.add(buildTaskList());
  return o;
...
void checkUnnamed7735(core.List<api.TaskList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Task> buildUnnamed7736() {
  var o = <api.Task>[];
  o.add(buildTask());
  o.add(buildTask());
  return o;
...
void checkUnnamed7736(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
