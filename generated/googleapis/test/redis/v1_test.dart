...
core.Map<core.String, api.GoogleCloudRedisV1ZoneMetadata> buildUnnamed2987() {
...
api.GoogleCloudRedisV1LocationMetadata
  ...
  if (buildCounterGoogleCloudRedisV1LocationMetadata < 3) {
    o.availableZones = buildUnnamed2987();
  }
  buildCounterGoogleCloudRedisV1LocationMetadata--;
  return o;
}
...
void checkGoogleCloudRedisV1LocationMetadata(
  ...
  buildCounterGoogleCloudRedisV1LocationMetadata++;
  if (buildCounterGoogleCloudRedisV1LocationMetadata < 3) {
    checkUnnamed2987(o.availableZones!);
  }
  buildCounterGoogleCloudRedisV1LocationMetadata--;
}
...
core.List<api.TlsCertificate> buildUnnamed2990() {
...
void checkUnnamed2990(core.List<api.TlsCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.port = 42;
    o.redisConfigs = buildUnnamed2989();
    o.redisVersion = 'foo';
    o.reservedIpRange = 'foo';
    o.serverCaCerts = buildUnnamed2990();
    o.state = 'foo';
    o.statusMessage = 'foo';
    o.tier = 'foo';
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed2989(o.redisConfigs!);
    unittest.expect(
      o.redisVersion!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed2990(o.serverCaCerts!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<api.Instance> buildUnnamed2991() {
  var o = <api.Instance>[];
  o.add(buildInstance());
  o.add(buildInstance());
  return o;
...
void checkUnnamed2991(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInstancesResponse buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed2991();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed2992();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
void checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed2991(o.instances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed2992(o.unreachable!);
  }
  buildCounterListInstancesResponse--;
}

core.List<api.Location> buildUnnamed2993() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed2993(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed2994() {
  var o = <api.Operation>[];
...
void checkUnnamed2994(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2996() {
...
void checkUnnamed2996(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.WeeklyMaintenanceWindow> buildUnnamed2997() {
...
void checkUnnamed2997(core.List<api.WeeklyMaintenanceWindow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MaintenancePolicy buildMaintenancePolicy() {
  ...
  if (buildCounterMaintenancePolicy < 3) {
    ...
    o.description = 'foo';
    o.updateTime = 'foo';
    o.weeklyMaintenanceWindow = buildUnnamed2997();
  }
  buildCounterMaintenancePolicy--;
  return o;
}
...
void checkMaintenancePolicy(api.MaintenancePolicy o) {
  ...
  if (buildCounterMaintenancePolicy < 3) {
    ...
    checkUnnamed2997(o.weeklyMaintenanceWindow!);
  }
  buildCounterMaintenancePolicy--;
}
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed2998();
    o.name = 'foo';
    o.response = buildUnnamed2999();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed2998(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2999(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3001() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed3000());
  o.add(buildUnnamed3000());
  return o;
}

void checkUnnamed3001(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3000(o[0]);
  checkUnnamed3000(o[1]);
}
