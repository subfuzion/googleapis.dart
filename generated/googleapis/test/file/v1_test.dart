...
core.List<api.NfsExportOptions> buildUnnamed7471() {
...
void checkUnnamed7471(core.List<api.NfsExportOptions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FileShareConfig buildFileShareConfig() {
  ...
  if (buildCounterFileShareConfig < 3) {
    o.capacityGb = 'foo';
    o.name = 'foo';
    o.nfsExportOptions = buildUnnamed7471();
    o.sourceBackup = 'foo';
  }
  buildCounterFileShareConfig--;
  return o;
...
void checkFileShareConfig(api.FileShareConfig o) {
  ...
  if (buildCounterFileShareConfig < 3) {
    ...
    checkUnnamed7471(o.nfsExportOptions!);
    unittest.expect(
      o.sourceBackup!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed7472() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7472(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed7477() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7477(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.GoogleCloudSaasacceleratorManagementProvidersV1Instance
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1Instance < 3) {
    ...
    o.createTime = 'foo';
    o.labels = buildUnnamed7472();
    o.maintenancePolicyNames = buildUnnamed7473();
    o.maintenanceSchedules = buildUnnamed7474();
    o.maintenanceSettings =
        buildGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings();
    o.name = 'foo';
    o.producerMetadata = buildUnnamed7475();
    o.provisionedResources = buildUnnamed7476();
    o.slmInstanceTemplate = 'foo';
    o.sloMetadata =
        buildGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata();
    o.softwareVersions = buildUnnamed7477();
    o.state = 'foo';
...
void checkGoogleCloudSaasacceleratorManagementProvidersV1Instance(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1Instance < 3) {
    ...
    checkUnnamed7472(o.labels!);
    checkUnnamed7473(o.maintenancePolicyNames!);
    checkUnnamed7474(o.maintenanceSchedules!);
    ...
    checkUnnamed7475(o.producerMetadata!);
    checkUnnamed7476(o.provisionedResources!);
    unittest.expect(
    ...
    checkUnnamed7477(o.softwareVersions!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.MaintenancePolicy> buildUnnamed7478() {
...
void checkUnnamed7478(core.Map<core.String, api.MaintenancePolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings <
    ...
    o.exclude = true;
    o.isRollback = true;
    o.maintenancePolicies = buildUnnamed7478();
  }
  buildCounterGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings--;
  return o;
}
...
void checkGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings <
    ...
    checkUnnamed7478(o.maintenancePolicies!);
  }
  buildCounterGoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings--;
}
...
api.GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility <
      3) {
    o.eligibilities = buildUnnamed7480();
  }
  buildCounterGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility--;
  return o;
}
...
void checkGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility <
      3) {
    checkUnnamed7480(o.eligibilities!);
  }
  buildCounterGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility--;
}
...
api.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata <
      3) {
    o.exclusions = buildUnnamed7481();
    o.nodes = buildUnnamed7482();
    o.perSliEligibility =
        buildGoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility();
    o.tier = 'foo';
  }
...
void checkGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata <
      3) {
    checkUnnamed7481(o.exclusions!);
    checkUnnamed7482(o.nodes!);
...
core.List<api.FileShareConfig> buildUnnamed7483() {
  var o = <api.FileShareConfig>[];
...
void checkUnnamed7483(core.List<api.FileShareConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileShareConfig(o[0] as api.FileShareConfig);
  checkFileShareConfig(o[1] as api.FileShareConfig);
}

core.Map<core.String, core.String> buildUnnamed7484() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7484(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.NetworkConfig> buildUnnamed7485() {
...
void checkUnnamed7485(core.List<api.NetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.description = 'foo';
    o.etag = 'foo';
    o.fileShares = buildUnnamed7483();
    o.labels = buildUnnamed7484();
    o.name = 'foo';
    o.networks = buildUnnamed7485();
    o.satisfiesPzs = true;
    o.state = 'foo';
    o.statusMessage = 'foo';
    o.tier = 'foo';
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed7483(o.fileShares!);
    checkUnnamed7484(o.labels!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed7485(o.networks!);
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
...
core.List<api.Backup> buildUnnamed7486() {
  var o = <api.Backup>[];
  o.add(buildBackup());
  o.add(buildBackup());
  return o;
...
void checkUnnamed7486(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Instance> buildUnnamed7488() {
  var o = <api.Instance>[];
  o.add(buildInstance());
  o.add(buildInstance());
  return o;
...
void checkUnnamed7488(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInstancesResponse buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed7488();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed7489();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
void checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed7488(o.instances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed7489(o.unreachable!);
  }
  buildCounterListInstancesResponse--;
}

core.List<api.Location> buildUnnamed7490() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed7490(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed7491() {
  var o = <api.Operation>[];
...
void checkUnnamed7491(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed7494() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7494(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.NetworkConfig buildNetworkConfig() {
  ...
  if (buildCounterNetworkConfig < 3) {
    o.ipAddresses = buildUnnamed7495();
    o.modes = buildUnnamed7496();
    o.network = 'foo';
...
void checkNetworkConfig(api.NetworkConfig o) {
  buildCounterNetworkConfig++;
  if (buildCounterNetworkConfig < 3) {
    checkUnnamed7495(o.ipAddresses!);
    checkUnnamed7496(o.modes!);
    unittest.expect(
      o.network!,
      unittest.equals('foo'),
    );
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed7498();
    o.name = 'foo';
    o.response = buildUnnamed7499();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed7498(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed7499(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7501() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7500());
  o.add(buildUnnamed7500());
  return o;
}

void checkUnnamed7501(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7500(o[0]);
  checkUnnamed7500(o[1]);
}
...
core.List<api.DenyMaintenancePeriod> buildUnnamed7502() {
  var o = <api.DenyMaintenancePeriod>[];
...
void checkUnnamed7502(core.List<api.DenyMaintenancePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UpdatePolicy buildUpdatePolicy() {
  ...
  if (buildCounterUpdatePolicy < 3) {
    o.channel = 'foo';
    o.denyMaintenancePeriods = buildUnnamed7502();
...
void checkUpdatePolicy(api.UpdatePolicy o) {
  ...
  if (buildCounterUpdatePolicy < 3) {
    ...
    checkUnnamed7502(o.denyMaintenancePeriods!);
    checkMaintenanceWindow(o.window! as api.MaintenanceWindow);
  }
  buildCounterUpdatePolicy--;
}

core.List<api.Schedule> buildUnnamed7503() {
  var o = <api.Schedule>[];
  o.add(buildSchedule());
  o.add(buildSchedule());
  return o;
...
void checkUnnamed7503(core.List<api.Schedule> o) {
  unittest.expect(o, unittest.hasLength(2));
