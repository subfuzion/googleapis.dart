...
core.List<api.Source> buildUnnamed2901() {
  var o = <api.Source>[];
  o.add(buildSource());
  o.add(buildSource());
  return o;
...
void checkUnnamed2901(core.List<api.Source> o) {
...
void checkAdministrationRegion(api.AdministrationRegion o) {
  ...
  if (buildCounterAdministrationRegion < 3) {
    ...
    checkUnnamed2901(o.sources!);
  }
  buildCounterAdministrationRegion--;
}

core.List<api.ElectionOfficial> buildUnnamed2902() {
...
void checkUnnamed2902(core.List<api.ElectionOfficial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AdministrativeBody buildAdministrativeBody() {
  ...
  if (buildCounterAdministrativeBody < 3) {
    ...
    o.electionOfficials = buildUnnamed2902();
    ...
    o.voterServices = buildUnnamed2903();
...
void checkAdministrativeBody(api.AdministrativeBody o) {
  ...
  if (buildCounterAdministrativeBody < 3) {
    ...
    checkUnnamed2902(o.electionOfficials!);
    unittest.expect(
    ...
    checkUnnamed2903(o.voterServices!);
    unittest.expect(
...
core.List<api.Channel> buildUnnamed2904() {
  var o = <api.Channel>[];
  o.add(buildChannel());
  o.add(buildChannel());
  return o;
...
void checkUnnamed2904(core.List<api.Channel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Candidate> buildUnnamed2905() {
  var o = <api.Candidate>[];
...
void checkUnnamed2905(core.List<api.Candidate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Contest buildContest() {
  ...
  if (buildCounterContest < 3) {
    ...
    o.ballotTitle = 'foo';
    o.candidates = buildUnnamed2905();
    o.district = buildElectoralDistrict();
    o.electorateSpecifications = 'foo';
    o.level = buildUnnamed2906();
    o.numberElected = 'foo';
    o.numberVotingFor = 'foo';
    o.office = 'foo';
    o.primaryParties = buildUnnamed2907();
    o.primaryParty = 'foo';
    o.referendumBallotResponses = buildUnnamed2908();
...
void checkContest(api.Contest o) {
  ...
  if (buildCounterContest < 3) {
    ...
    checkUnnamed2907(o.primaryParties!);
    unittest.expect(
      o.primaryParty!,
      unittest.equals('foo'),
    );
    checkUnnamed2908(o.referendumBallotResponses!);
    unittest.expect(
      o.referendumBrief!,
      unittest.equals('foo'),
    );
...
core.List<api.DivisionSearchResult> buildUnnamed2911() {
...
void checkUnnamed2911(core.List<api.DivisionSearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Election> buildUnnamed2913() {
  var o = <api.Election>[];
  o.add(buildElection());
  o.add(buildElection());
  return o;
...
void checkUnnamed2913(core.List<api.Election> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed2915() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed2915(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.GeographicDivision buildGeographicDivision() {
  ...
  if (buildCounterGeographicDivision < 3) {
    o.alsoKnownAs = buildUnnamed2914();
    o.name = 'foo';
    o.officeIndices = buildUnnamed2915();
  }
  buildCounterGeographicDivision--;
  return o;
}
...
void checkGeographicDivision(api.GeographicDivision o) {
  buildCounterGeographicDivision++;
  if (buildCounterGeographicDivision < 3) {
    checkUnnamed2914(o.alsoKnownAs!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2915(o.officeIndices!);
  }
  buildCounterGeographicDivision--;
}
...
core.List<core.int> buildUnnamed2917() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed2917(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Office buildOffice() {
  ...
  if (buildCounterOffice < 3) {
    o.divisionId = 'foo';
    o.levels = buildUnnamed2916();
    o.name = 'foo';
    o.officialIndices = buildUnnamed2917();
...
void checkOffice(api.Office o) {
  ...
  if (buildCounterOffice < 3) {
    ...
    checkUnnamed2916(o.levels!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2917(o.officialIndices!);
...
core.List<api.SimpleAddressType> buildUnnamed2920() {
...
void checkUnnamed2921(core.List<api.Channel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChannel(o[0] as api.Channel);
  checkChannel(o[1] as api.Channel);
}
...
api.Official buildOfficial() {
  ...
  if (buildCounterOfficial < 3) {
    o.address = buildUnnamed2920();
    o.channels = buildUnnamed2921();
    o.emails = buildUnnamed2922();
    o.name = 'foo';
    o.party = 'foo';
    o.phones = buildUnnamed2923();
    o.photoUrl = 'foo';
    o.urls = buildUnnamed2924();
  }
  buildCounterOfficial--;
  return o;
}
...
void checkOfficial(api.Official o) {
  buildCounterOfficial++;
  if (buildCounterOfficial < 3) {
    checkUnnamed2920(o.address!);
    checkUnnamed2921(o.channels!);
    checkUnnamed2922(o.emails!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed2923(o.phones!);
    unittest.expect(
      o.photoUrl!,
      unittest.equals('foo'),
    );
    checkUnnamed2924(o.urls!);
  }
  buildCounterOfficial--;
}

core.List<api.Source> buildUnnamed2925() {
  var o = <api.Source>[];
  o.add(buildSource());
  o.add(buildSource());
  return o;
...
void checkUnnamed2925(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0] as api.Source);
  checkSource(o[1] as api.Source);
}
...
core.Map<core.String, api.GeographicDivision> buildUnnamed2926() {
...
void checkUnnamed2927(core.List<api.Office> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOffice(o[0] as api.Office);
  checkOffice(o[1] as api.Office);
}

core.List<api.Official> buildUnnamed2928() {
  var o = <api.Official>[];
  o.add(buildOfficial());
  o.add(buildOfficial());
  return o;
...
void checkUnnamed2928(core.List<api.Official> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RepresentativeInfoData buildRepresentativeInfoData() {
  ...
  if (buildCounterRepresentativeInfoData < 3) {
    o.divisions = buildUnnamed2926();
    o.offices = buildUnnamed2927();
    o.officials = buildUnnamed2928();
  }
  buildCounterRepresentativeInfoData--;
  return o;
}
...
void checkRepresentativeInfoData(api.RepresentativeInfoData o) {
  buildCounterRepresentativeInfoData++;
  if (buildCounterRepresentativeInfoData < 3) {
    checkUnnamed2926(o.divisions!);
    checkUnnamed2927(o.offices!);
    checkUnnamed2928(o.officials!);
  }
  buildCounterRepresentativeInfoData--;
}

core.Map<core.String, api.GeographicDivision> buildUnnamed2929() {
  var o = <core.String, api.GeographicDivision>{};
  o['x'] = buildGeographicDivision();
  o['y'] = buildGeographicDivision();
  return o;
...
void checkUnnamed2929(core.Map<core.String, api.GeographicDivision> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGeographicDivision(o['x']! as api.GeographicDivision);
  checkGeographicDivision(o['y']! as api.GeographicDivision);
}

core.List<api.Office> buildUnnamed2930() {
  var o = <api.Office>[];
  o.add(buildOffice());
  o.add(buildOffice());
  return o;
...
void checkUnnamed2930(core.List<api.Office> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOffice(o[0] as api.Office);
  checkOffice(o[1] as api.Office);
}

core.List<api.Official> buildUnnamed2931() {
  var o = <api.Official>[];
  o.add(buildOfficial());
  o.add(buildOfficial());
  return o;
...
void checkUnnamed2931(core.List<api.Official> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOfficial(o[0] as api.Official);
  checkOfficial(o[1] as api.Official);
}
...
api.RepresentativeInfoResponse buildRepresentativeInfoResponse() {
  ...
  if (buildCounterRepresentativeInfoResponse < 3) {
    o.divisions = buildUnnamed2929();
    o.kind = 'foo';
    o.normalizedInput = buildSimpleAddressType();
    o.offices = buildUnnamed2930();
    o.officials = buildUnnamed2931();
  }
  buildCounterRepresentativeInfoResponse--;
  return o;
}
...
void checkRepresentativeInfoResponse(api.RepresentativeInfoResponse o) {
  buildCounterRepresentativeInfoResponse++;
  if (buildCounterRepresentativeInfoResponse < 3) {
    checkUnnamed2929(o.divisions!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkSimpleAddressType(o.normalizedInput! as api.SimpleAddressType);
    checkUnnamed2930(o.offices!);
    checkUnnamed2931(o.officials!);
  }
  buildCounterRepresentativeInfoResponse--;
}
...
core.List<api.Contest> buildUnnamed2932() {
  var o = <api.Contest>[];
  o.add(buildContest());
  o.add(buildContest());
  return o;
...
void checkUnnamed2932(core.List<api.Contest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Election> buildUnnamed2935() {
  var o = <api.Election>[];
  o.add(buildElection());
  o.add(buildElection());
  return o;
...
void checkUnnamed2935(core.List<api.Election> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkElection(o[0] as api.Election);
  checkElection(o[1] as api.Election);
}

core.List<api.PollingLocation> buildUnnamed2936() {
  var o = <api.PollingLocation>[];
  o.add(buildPollingLocation());
  o.add(buildPollingLocation());
  return o;
...
void checkUnnamed2936(core.List<api.PollingLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPollingLocation(o[0] as api.PollingLocation);
  checkPollingLocation(o[1] as api.PollingLocation);
}

core.List<api.AdministrationRegion> buildUnnamed2937() {
  var o = <api.AdministrationRegion>[];
...
void checkUnnamed2937(core.List<api.AdministrationRegion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VoterInfoResponse buildVoterInfoResponse() {
  ...
  if (buildCounterVoterInfoResponse < 3) {
    o.contests = buildUnnamed2932();
    o.dropOffLocations = buildUnnamed2933();
    o.earlyVoteSites = buildUnnamed2934();
    o.election = buildElection();
    o.kind = 'foo';
    o.mailOnly = true;
    o.normalizedInput = buildSimpleAddressType();
    o.otherElections = buildUnnamed2935();
    o.pollingLocations = buildUnnamed2936();
    o.precinctId = 'foo';
    o.state = buildUnnamed2937();
  }
  buildCounterVoterInfoResponse--;
  return o;
}
...
void checkVoterInfoResponse(api.VoterInfoResponse o) {
  buildCounterVoterInfoResponse++;
  if (buildCounterVoterInfoResponse < 3) {
    checkUnnamed2932(o.contests!);
    checkUnnamed2933(o.dropOffLocations!);
    checkUnnamed2934(o.earlyVoteSites!);
    ...
    checkSimpleAddressType(o.normalizedInput! as api.SimpleAddressType);
    checkUnnamed2935(o.otherElections!);
    checkUnnamed2936(o.pollingLocations!);
    unittest.expect(
      o.precinctId!,
      unittest.equals('foo'),
    );
    checkUnnamed2937(o.state!);
  }
  buildCounterVoterInfoResponse--;
}
...
void main() {
  ...
  unittest.group('resource-RepresentativesResource', () {
    unittest.test('method--representativeInfoByAddress', () async {
      ...
      var arg_levels = buildUnnamed2938();
      var arg_roles = buildUnnamed2939();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--representativeInfoByDivision', () async {
      ...
      var res = api.CivicInfoApi(mock).representatives;
      var arg_ocdId = 'foo';
      var arg_levels = buildUnnamed2940();
      var arg_recursive = true;
      var arg_roles = buildUnnamed2941();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
