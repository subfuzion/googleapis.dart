...
api.AllocateInfo buildAllocateInfo() {
  ...
  if (buildCounterAllocateInfo < 3) {
    o.unusedArguments = buildUnnamed2799();
  }
  buildCounterAllocateInfo--;
  return o;
}
...
void checkAllocateInfo(api.AllocateInfo o) {
  buildCounterAllocateInfo++;
  if (buildCounterAllocateInfo < 3) {
    checkUnnamed2799(o.unusedArguments!);
  }
  buildCounterAllocateInfo--;
}
...
core.List<api.QuotaError> buildUnnamed2800() {
...
void checkUnnamed2800(core.List<api.QuotaError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaError(o[0] as api.QuotaError);
  checkQuotaError(o[1] as api.QuotaError);
}

core.List<api.MetricValueSet> buildUnnamed2801() {
...
void checkUnnamed2801(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AllocateQuotaResponse buildAllocateQuotaResponse() {
  ...
  if (buildCounterAllocateQuotaResponse < 3) {
    o.allocateErrors = buildUnnamed2800();
    o.allocateInfo = buildAllocateInfo();
    o.operationId = 'foo';
    o.quotaMetrics = buildUnnamed2801();
    o.serviceConfigId = 'foo';
  }
  buildCounterAllocateQuotaResponse--;
  return o;
...
void checkAllocateQuotaResponse(api.AllocateQuotaResponse o) {
  buildCounterAllocateQuotaResponse++;
  if (buildCounterAllocateQuotaResponse < 3) {
    checkUnnamed2800(o.allocateErrors!);
    checkAllocateInfo(o.allocateInfo! as api.AllocateInfo);
    unittest.expect(
      o.operationId!,
      unittest.equals('foo'),
    );
    checkUnnamed2801(o.quotaMetrics!);
    unittest.expect(
      o.serviceConfigId!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.AttributeValue> buildUnnamed2802() {
...
void checkUnnamed2802(core.Map<core.String, api.AttributeValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed2802();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed2802(o.attributeMap!);
    unittest.expect(
...
core.List<api.AuthorizationInfo> buildUnnamed2803() {
...
void checkUnnamed2803(core.List<api.AuthorizationInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuditLog buildAuditLog() {
  ...
  if (buildCounterAuditLog < 3) {
    ...
    o.authorizationInfo = buildUnnamed2803();
    o.metadata = buildUnnamed2804();
    o.methodName = 'foo';
    o.numResponseItems = 'foo';
    o.request = buildUnnamed2805();
    o.requestMetadata = buildRequestMetadata();
    o.resourceLocation = buildResourceLocation();
    o.resourceName = 'foo';
    o.resourceOriginalState = buildUnnamed2806();
    o.response = buildUnnamed2807();
    o.serviceData = buildUnnamed2808();
    o.serviceName = 'foo';
...
void checkAuditLog(api.AuditLog o) {
  ...
  if (buildCounterAuditLog < 3) {
    ...
    checkUnnamed2803(o.authorizationInfo!);
    checkUnnamed2804(o.metadata!);
    unittest.expect(
      o.methodName!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed2806(o.resourceOriginalState!);
    checkUnnamed2807(o.response!);
    checkUnnamed2808(o.serviceData!);
    unittest.expect(
      o.serviceName!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed2811() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2811(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Auth buildAuth() {
  ...
  if (buildCounterAuth < 3) {
    o.accessLevels = buildUnnamed2809();
    o.audiences = buildUnnamed2810();
    o.claims = buildUnnamed2811();
    o.presenter = 'foo';
    o.principal = 'foo';
  }
  buildCounterAuth--;
...
void checkAuth(api.Auth o) {
  buildCounterAuth++;
  if (buildCounterAuth < 3) {
    checkUnnamed2809(o.accessLevels!);
    checkUnnamed2810(o.audiences!);
    checkUnnamed2811(o.claims!);
    unittest.expect(
      o.presenter!,
      unittest.equals('foo'),
    );
...
core.List<api.ServiceAccountDelegationInfo> buildUnnamed2812() {
...
void checkUnnamed2812(core.List<api.ServiceAccountDelegationInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthenticationInfo buildAuthenticationInfo() {
  ...
  if (buildCounterAuthenticationInfo < 3) {
    ...
    o.serviceAccountDelegationInfo = buildUnnamed2812();
    o.serviceAccountKeyName = 'foo';
    o.thirdPartyPrincipal = buildUnnamed2813();
  }
  buildCounterAuthenticationInfo--;
  return o;
}
...
void checkAuthenticationInfo(api.AuthenticationInfo o) {
  ...
  if (buildCounterAuthenticationInfo < 3) {
    ...
    checkUnnamed2812(o.serviceAccountDelegationInfo!);
    unittest.expect(
      o.serviceAccountKeyName!,
      unittest.equals('foo'),
    );
    checkUnnamed2813(o.thirdPartyPrincipal!);
  }
  buildCounterAuthenticationInfo--;
}
...
api.CheckInfo buildCheckInfo() {
  ...
  if (buildCounterCheckInfo < 3) {
    ...
    o.unusedArguments = buildUnnamed2814();
  }
  buildCounterCheckInfo--;
  return o;
}
...
void checkCheckInfo(api.CheckInfo o) {
  ...
  if (buildCounterCheckInfo < 3) {
    ...
    checkUnnamed2814(o.unusedArguments!);
  }
  buildCounterCheckInfo--;
}
...
core.List<api.CheckError> buildUnnamed2815() {
  var o = <api.CheckError>[];
...
void checkUnnamed2815(core.List<api.CheckError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CheckResponse buildCheckResponse() {
  ...
  if (buildCounterCheckResponse < 3) {
    o.checkErrors = buildUnnamed2815();
...
void checkCheckResponse(api.CheckResponse o) {
  buildCounterCheckResponse++;
  if (buildCounterCheckResponse < 3) {
    checkUnnamed2815(o.checkErrors!);
...
core.List<core.String> buildUnnamed2816() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed2816(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Exemplar> buildUnnamed2817() {
  var o = <api.Exemplar>[];
  o.add(buildExemplar());
  o.add(buildExemplar());
  return o;
...
void checkUnnamed2817(core.List<api.Exemplar> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Distribution buildDistribution() {
  ...
  if (buildCounterDistribution < 3) {
    o.bucketCounts = buildUnnamed2816();
    o.count = 'foo';
    o.exemplars = buildUnnamed2817();
...
void checkDistribution(api.Distribution o) {
  buildCounterDistribution++;
  if (buildCounterDistribution < 3) {
    checkUnnamed2816(o.bucketCounts!);
    unittest.expect(
      o.count!,
      unittest.equals('foo'),
    );
    checkUnnamed2817(o.exemplars!);
...
core.Map<core.String, core.Object> buildUnnamed2818() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2818(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2819() {
...
void checkUnnamed2819(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Exemplar buildExemplar() {
  ...
  if (buildCounterExemplar < 3) {
    o.attachments = buildUnnamed2819();
    o.timestamp = 'foo';
    o.value = 42.0;
  }
  buildCounterExemplar--;
...
void checkExemplar(api.Exemplar o) {
  buildCounterExemplar++;
  if (buildCounterExemplar < 3) {
    checkUnnamed2819(o.attachments!);
    unittest.expect(
      o.timestamp!,
      unittest.equals('foo'),
    );
...
core.List<core.double> buildUnnamed2820() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed2820(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42.0),
...
core.Map<core.String, core.Object> buildUnnamed2821() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2821(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FirstPartyPrincipal buildFirstPartyPrincipal() {
  ...
  if (buildCounterFirstPartyPrincipal < 3) {
    o.principalEmail = 'foo';
    o.serviceMetadata = buildUnnamed2821();
  }
  buildCounterFirstPartyPrincipal--;
  return o;
}
...
void checkFirstPartyPrincipal(api.FirstPartyPrincipal o) {
  ...
  if (buildCounterFirstPartyPrincipal < 3) {
    ...
    checkUnnamed2821(o.serviceMetadata!);
  }
  buildCounterFirstPartyPrincipal--;
}
...
core.Map<core.String, core.String> buildUnnamed2822() {
...
void checkUnnamed2822(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.LogEntry buildLogEntry() {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    o.insertId = 'foo';
    o.labels = buildUnnamed2822();
    o.name = 'foo';
    o.operation = buildLogEntryOperation();
    o.protoPayload = buildUnnamed2823();
    o.severity = 'foo';
    o.sourceLocation = buildLogEntrySourceLocation();
    o.structPayload = buildUnnamed2824();
    o.textPayload = 'foo';
    o.timestamp = 'foo';
    o.trace = 'foo';
  }
...
void checkLogEntry(api.LogEntry o) {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    checkUnnamed2824(o.structPayload!);
    unittest.expect(
      o.textPayload!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed2825() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2825(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.MetricValue> buildUnnamed2826() {
  var o = <api.MetricValue>[];
...
void checkUnnamed2826(core.List<api.MetricValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricValueSet buildMetricValueSet() {
  ...
  if (buildCounterMetricValueSet < 3) {
    o.metricName = 'foo';
    o.metricValues = buildUnnamed2826();
  }
  buildCounterMetricValueSet--;
  return o;
}
...
void checkMetricValueSet(api.MetricValueSet o) {
  ...
  if (buildCounterMetricValueSet < 3) {
    ...
    checkUnnamed2826(o.metricValues!);
  }
  buildCounterMetricValueSet--;
}
...
core.Map<core.String, core.String> buildUnnamed2829() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2829(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.LogEntry> buildUnnamed2830() {
  var o = <api.LogEntry>[];
  o.add(buildLogEntry());
  o.add(buildLogEntry());
  return o;
...
void checkUnnamed2830(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0] as api.LogEntry);
  checkLogEntry(o[1] as api.LogEntry);
}

core.List<api.MetricValueSet> buildUnnamed2831() {
  var o = <api.MetricValueSet>[];
  o.add(buildMetricValueSet());
  o.add(buildMetricValueSet());
  return o;
...
void checkUnnamed2831(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricValueSet(o[0] as api.MetricValueSet);
  checkMetricValueSet(o[1] as api.MetricValueSet);
}

core.List<api.ResourceInfo> buildUnnamed2832() {
...
void checkUnnamed2832(core.List<api.ResourceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceInfo(o[0] as api.ResourceInfo);
  checkResourceInfo(o[1] as api.ResourceInfo);
}

core.List<api.TraceSpan> buildUnnamed2833() {
  var o = <api.TraceSpan>[];
...
void checkUnnamed2833(core.List<api.TraceSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.consumerId = 'foo';
    o.endTime = 'foo';
    o.extensions = buildUnnamed2828();
    o.importance = 'foo';
    o.labels = buildUnnamed2829();
    o.logEntries = buildUnnamed2830();
    o.metricValueSets = buildUnnamed2831();
    o.operationId = 'foo';
    o.operationName = 'foo';
    o.quotaProperties = buildQuotaProperties();
    o.resources = buildUnnamed2832();
    o.startTime = 'foo';
    o.traceSpans = buildUnnamed2833();
    o.userLabels = buildUnnamed2834();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed2828(o.extensions!);
    unittest.expect(
      o.importance!,
      unittest.equals('foo'),
    );
    checkUnnamed2829(o.labels!);
    checkUnnamed2830(o.logEntries!);
    checkUnnamed2831(o.metricValueSets!);
    unittest.expect(
      o.operationId!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed2832(o.resources!);
    unittest.expect(
      o.startTime!,
      unittest.equals('foo'),
    );
    checkUnnamed2833(o.traceSpans!);
    checkUnnamed2834(o.userLabels!);
  }
  buildCounterOperation--;
}
...
core.Map<core.String, core.int> buildUnnamed2837() {
...
void checkUnnamed2837(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals(42),
...
core.List<api.MetricValueSet> buildUnnamed2838() {
  var o = <api.MetricValueSet>[];
  o.add(buildMetricValueSet());
  o.add(buildMetricValueSet());
  return o;
...
void checkUnnamed2838(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricValueSet(o[0] as api.MetricValueSet);
  checkMetricValueSet(o[1] as api.MetricValueSet);
}
...
api.QuotaInfo buildQuotaInfo() {
  ...
  if (buildCounterQuotaInfo < 3) {
    o.limitExceeded = buildUnnamed2836();
    o.quotaConsumed = buildUnnamed2837();
    o.quotaMetrics = buildUnnamed2838();
  }
  buildCounterQuotaInfo--;
  return o;
}
...
void checkQuotaInfo(api.QuotaInfo o) {
  buildCounterQuotaInfo++;
  if (buildCounterQuotaInfo < 3) {
    checkUnnamed2836(o.limitExceeded!);
    checkUnnamed2837(o.quotaConsumed!);
    checkUnnamed2838(o.quotaMetrics!);
  }
  buildCounterQuotaInfo--;
}

core.Map<core.String, core.String> buildUnnamed2839() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2839(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.QuotaOperation buildQuotaOperation() {
  ...
  if (buildCounterQuotaOperation < 3) {
    ...
    o.methodName = 'foo';
    o.operationId = 'foo';
    o.quotaMetrics = buildUnnamed2840();
    o.quotaMode = 'foo';
  }
  buildCounterQuotaOperation--;
  return o;
...
void checkQuotaOperation(api.QuotaOperation o) {
  ...
  if (buildCounterQuotaOperation < 3) {
    ...
    checkUnnamed2840(o.quotaMetrics!);
    unittest.expect(
      o.quotaMode!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed2841() {
  var o = <api.Operation>[];
...
void checkUnnamed2841(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportError> buildUnnamed2842() {
  var o = <api.ReportError>[];
...
void checkUnnamed2842(core.List<api.ReportError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReportResponse buildReportResponse() {
  ...
  if (buildCounterReportResponse < 3) {
    o.reportErrors = buildUnnamed2842();
    o.serviceConfigId = 'foo';
    o.serviceRolloutId = 'foo';
  }
  buildCounterReportResponse--;
...
void checkReportResponse(api.ReportResponse o) {
  buildCounterReportResponse++;
  if (buildCounterReportResponse < 3) {
    checkUnnamed2842(o.reportErrors!);
    unittest.expect(
      o.serviceConfigId!,
      unittest.equals('foo'),
    );
...
api.Resource buildResource() {
  ...
  if (buildCounterResource < 3) {
    o.annotations = buildUnnamed2844();
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.displayName = 'foo';
    o.etag = 'foo';
...
void checkResource(api.Resource o) {
  buildCounterResource++;
  if (buildCounterResource < 3) {
    checkUnnamed2844(o.annotations!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
api.ResourceLocation buildResourceLocation() {
  ...
  if (buildCounterResourceLocation < 3) {
    o.currentLocations = buildUnnamed2846();
    o.originalLocations = buildUnnamed2847();
  }
  buildCounterResourceLocation--;
  return o;
}
...
void checkResourceLocation(api.ResourceLocation o) {
  buildCounterResourceLocation++;
  if (buildCounterResourceLocation < 3) {
    checkUnnamed2846(o.currentLocations!);
    checkUnnamed2847(o.originalLocations!);
  }
  buildCounterResourceLocation--;
}
...
core.Map<core.String, core.Object> buildUnnamed2848() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2848(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2849() {
  var o = <core.Map<core.String, core.Object>>[];
...
void checkUnnamed2849(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ThirdPartyPrincipal buildThirdPartyPrincipal() {
  ...
  if (buildCounterThirdPartyPrincipal < 3) {
    o.thirdPartyClaims = buildUnnamed2850();
  }
  buildCounterThirdPartyPrincipal--;
  return o;
}
...
void checkThirdPartyPrincipal(api.ThirdPartyPrincipal o) {
  buildCounterThirdPartyPrincipal++;
  if (buildCounterThirdPartyPrincipal < 3) {
    checkUnnamed2850(o.thirdPartyClaims!);
  }
  buildCounterThirdPartyPrincipal--;
}
