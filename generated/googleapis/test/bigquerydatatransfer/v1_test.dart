...
core.List<api.DataSourceParameter> buildUnnamed2964() {
...
void checkUnnamed2964(core.List<api.DataSourceParameter> o) {
...
api.DataSource buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.name = 'foo';
    o.parameters = buildUnnamed2964();
    o.scopes = buildUnnamed2965();
...
void checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed2964(o.parameters!);
    checkUnnamed2965(o.scopes!);
...
core.List<api.DataSourceParameter> buildUnnamed2967() {
  var o = <api.DataSourceParameter>[];
  o.add(buildDataSourceParameter());
  o.add(buildDataSourceParameter());
  return o;
...
void checkUnnamed2967(core.List<api.DataSourceParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceParameter(o[0] as api.DataSourceParameter);
  checkDataSourceParameter(o[1] as api.DataSourceParameter);
}
...
api.DataSourceParameter buildDataSourceParameter() {
  ...
  if (buildCounterDataSourceParameter < 3) {
    o.allowedValues = buildUnnamed2966();
    o.deprecated = true;
    o.description = 'foo';
    o.displayName = 'foo';
    o.fields = buildUnnamed2967();
    o.immutable = true;
    o.maxValue = 42.0;
    o.minValue = 42.0;
    o.paramId = 'foo';
...
void checkDataSourceParameter(api.DataSourceParameter o) {
  buildCounterDataSourceParameter++;
  if (buildCounterDataSourceParameter < 3) {
    checkUnnamed2966(o.allowedValues!);
...
core.List<api.DataSource> buildUnnamed2968() {
  var o = <api.DataSource>[];
...
void checkUnnamed2968(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDataSourcesResponse buildListDataSourcesResponse() {
  ...
  if (buildCounterListDataSourcesResponse < 3) {
    o.dataSources = buildUnnamed2968();
    o.nextPageToken = 'foo';
  }
  buildCounterListDataSourcesResponse--;
  return o;
...
void checkListDataSourcesResponse(api.ListDataSourcesResponse o) {
  buildCounterListDataSourcesResponse++;
  if (buildCounterListDataSourcesResponse < 3) {
    checkUnnamed2968(o.dataSources!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Location> buildUnnamed2969() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed2969(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TransferConfig> buildUnnamed2970() {
...
void checkUnnamed2970(core.List<api.TransferConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTransferConfigsResponse buildListTransferConfigsResponse() {
  ...
  if (buildCounterListTransferConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.transferConfigs = buildUnnamed2970();
  }
  buildCounterListTransferConfigsResponse--;
  return o;
}
...
void checkListTransferConfigsResponse(api.ListTransferConfigsResponse o) {
  ...
  if (buildCounterListTransferConfigsResponse < 3) {
    ...
    checkUnnamed2970(o.transferConfigs!);
  }
  buildCounterListTransferConfigsResponse--;
}

core.List<api.TransferMessage> buildUnnamed2971() {
...
void checkUnnamed2971(core.List<api.TransferMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTransferLogsResponse buildListTransferLogsResponse() {
  ...
  if (buildCounterListTransferLogsResponse < 3) {
    o.nextPageToken = 'foo';
    o.transferMessages = buildUnnamed2971();
  }
  buildCounterListTransferLogsResponse--;
  return o;
}
...
void checkListTransferLogsResponse(api.ListTransferLogsResponse o) {
  ...
  if (buildCounterListTransferLogsResponse < 3) {
    ...
    checkUnnamed2971(o.transferMessages!);
  }
  buildCounterListTransferLogsResponse--;
}

core.List<api.TransferRun> buildUnnamed2972() {
...
void checkUnnamed2972(core.List<api.TransferRun> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTransferRunsResponse buildListTransferRunsResponse() {
  ...
  if (buildCounterListTransferRunsResponse < 3) {
    o.nextPageToken = 'foo';
    o.transferRuns = buildUnnamed2972();
  }
  buildCounterListTransferRunsResponse--;
  return o;
}
...
void checkListTransferRunsResponse(api.ListTransferRunsResponse o) {
  ...
  if (buildCounterListTransferRunsResponse < 3) {
    ...
    checkUnnamed2972(o.transferRuns!);
  }
  buildCounterListTransferRunsResponse--;
}
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed2973();
    o.locationId = 'foo';
    o.metadata = buildUnnamed2974();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed2973(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed2974(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed2977() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2977(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2978() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed2977());
  o.add(buildUnnamed2977());
  return o;
}

void checkUnnamed2978(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2977(o[0]);
  checkUnnamed2977(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsTransferConfigsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res =
          api.BigQueryDataTransferApi(mock).projects.locations.transferConfigs;
      var arg_parent = 'foo';
      var arg_dataSourceIds = buildUnnamed2981();
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsTransferConfigsRunsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_states = buildUnnamed2982();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group(
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.BigQueryDataTransferApi(mock)
          ...
          .transferLogs;
      var arg_parent = 'foo';
      var arg_messageTypes = buildUnnamed2983();
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsTransferConfigsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.BigQueryDataTransferApi(mock).projects.transferConfigs;
      var arg_parent = 'foo';
      var arg_dataSourceIds = buildUnnamed2984();
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsTransferConfigsRunsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageToken = 'foo';
      var arg_runAttempt = 'foo';
      var arg_states = buildUnnamed2985();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-ProjectsTransferConfigsRunsTransferLogsResource',
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.BigQueryDataTransferApi(mock)
          ...
          .transferLogs;
      var arg_parent = 'foo';
      var arg_messageTypes = buildUnnamed2986();
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
