...
api.AuditRefs buildAuditRefs() {
  ...
  if (buildCounterAuditRefs < 3) {
    ...
    o.group = 'foo';
    o.id = 'foo';
    o.relevantAudits = buildUnnamed3195();
    o.weight = 42.0;
  }
  buildCounterAuditRefs--;
  return o;
...
void checkAuditRefs(api.AuditRefs o) {
  ...
  if (buildCounterAuditRefs < 3) {
    ...
    checkUnnamed3195(o.relevantAudits!);
    unittest.expect(
      o.weight!,
...
core.List<api.AuditRefs> buildUnnamed3197() {
  var o = <api.AuditRefs>[];
...
void checkUnnamed3197(core.List<api.AuditRefs> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.LighthouseAuditResultV5> buildUnnamed3198() {
...
void checkUnnamed3198(core.Map<core.String, api.LighthouseAuditResultV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.CategoryGroupV5> buildUnnamed3199() {
...
void checkUnnamed3199(core.Map<core.String, api.CategoryGroupV5> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCategoryGroupV5(o['x']! as api.CategoryGroupV5);
  checkCategoryGroupV5(o['y']! as api.CategoryGroupV5);
}

core.List<core.Object> buildUnnamed3200() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed3200(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StackPack> buildUnnamed3201() {
  var o = <api.StackPack>[];
...
void checkUnnamed3201(core.List<api.StackPack> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LighthouseResultV5 buildLighthouseResultV5() {
  ...
  if (buildCounterLighthouseResultV5 < 3) {
    o.audits = buildUnnamed3198();
    o.categories = buildCategories();
    o.categoryGroups = buildUnnamed3199();
    ...
    o.requestedUrl = 'foo';
    o.runWarnings = buildUnnamed3200();
    o.runtimeError = buildRuntimeError();
    o.stackPacks = buildUnnamed3201();
...
void checkLighthouseResultV5(api.LighthouseResultV5 o) {
  buildCounterLighthouseResultV5++;
  if (buildCounterLighthouseResultV5 < 3) {
    checkUnnamed3198(o.audits!);
    checkCategories(o.categories! as api.Categories);
    checkUnnamed3199(o.categoryGroups!);
    ...
    checkUnnamed3200(o.runWarnings!);
    checkRuntimeError(o.runtimeError! as api.RuntimeError);
    checkUnnamed3201(o.stackPacks!);
...
core.Map<core.String, api.UserPageLoadMetricV5> buildUnnamed3202() {
...
void checkUnnamed3202(core.Map<core.String, api.UserPageLoadMetricV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StackPack buildStackPack() {
  ...
  if (buildCounterStackPack < 3) {
    o.descriptions = buildUnnamed3203();
    o.iconDataURL = 'foo';
    o.id = 'foo';
    o.title = 'foo';
  }
...
void checkStackPack(api.StackPack o) {
  buildCounterStackPack++;
  if (buildCounterStackPack < 3) {
    checkUnnamed3203(o.descriptions!);
    unittest.expect(
      o.iconDataURL!,
      unittest.equals('foo'),
    );
...
core.List<api.Bucket> buildUnnamed3204() {
  var o = <api.Bucket>[];
  o.add(buildBucket());
  o.add(buildBucket());
  return o;
...
void checkUnnamed3204(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UserPageLoadMetricV5 buildUserPageLoadMetricV5() {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    o.category = 'foo';
    o.distributions = buildUnnamed3204();
    o.formFactor = 'foo';
    o.median = 42;
    o.metricId = 'foo';
    o.percentile = 42;
...
void checkUserPageLoadMetricV5(api.UserPageLoadMetricV5 o) {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    ...
    checkUnnamed3204(o.distributions!);
    unittest.expect(
      o.formFactor!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-PagespeedapiResource', () {
    unittest.test('method--runpagespeed', () async {
      ...
      var arg_category = buildUnnamed3205();
      var arg_locale = 'foo';
