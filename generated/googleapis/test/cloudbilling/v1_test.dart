...
core.List<api.AuditLogConfig> buildUnnamed3016() {
...
void checkUnnamed3016(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed3016();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed3016(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed3017();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed3017(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.BillingAccount> buildUnnamed3020() {
  var o = <api.BillingAccount>[];
...
void checkUnnamed3020(core.List<api.BillingAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListBillingAccountsResponse buildListBillingAccountsResponse() {
  ...
  if (buildCounterListBillingAccountsResponse < 3) {
    o.billingAccounts = buildUnnamed3020();
    o.nextPageToken = 'foo';
  }
  buildCounterListBillingAccountsResponse--;
  return o;
...
void checkListBillingAccountsResponse(api.ListBillingAccountsResponse o) {
  buildCounterListBillingAccountsResponse++;
  if (buildCounterListBillingAccountsResponse < 3) {
    checkUnnamed3020(o.billingAccounts!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.ProjectBillingInfo> buildUnnamed3021() {
...
void checkUnnamed3021(core.List<api.ProjectBillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListProjectBillingInfoResponse buildListProjectBillingInfoResponse() {
  ...
  if (buildCounterListProjectBillingInfoResponse < 3) {
    o.nextPageToken = 'foo';
    o.projectBillingInfo = buildUnnamed3021();
  }
  buildCounterListProjectBillingInfoResponse--;
  return o;
}
...
void checkListProjectBillingInfoResponse(api.ListProjectBillingInfoResponse o) {
  ...
  if (buildCounterListProjectBillingInfoResponse < 3) {
    ...
    checkUnnamed3021(o.projectBillingInfo!);
  }
  buildCounterListProjectBillingInfoResponse--;
}

core.List<api.Service> buildUnnamed3022() {
  var o = <api.Service>[];
  o.add(buildService());
  o.add(buildService());
  return o;
...
void checkUnnamed3022(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListServicesResponse(api.ListServicesResponse o) {
  ...
  if (buildCounterListServicesResponse < 3) {
    ...
    checkUnnamed3022(o.services!);
  }
  buildCounterListServicesResponse--;
}

core.List<api.Sku> buildUnnamed3023() {
  var o = <api.Sku>[];
  o.add(buildSku());
  o.add(buildSku());
  return o;
...
void checkUnnamed3023(core.List<api.Sku> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AuditConfig> buildUnnamed3024() {
  var o = <api.AuditConfig>[];
...
void checkUnnamed3024(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0] as api.AuditConfig);
  checkAuditConfig(o[1] as api.AuditConfig);
}

core.List<api.Binding> buildUnnamed3025() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed3025(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed3024();
    o.bindings = buildUnnamed3025();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed3024(o.auditConfigs!);
    checkUnnamed3025(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.TierRate> buildUnnamed3026() {
  var o = <api.TierRate>[];
  o.add(buildTierRate());
  o.add(buildTierRate());
  return o;
...
void checkUnnamed3026(core.List<api.TierRate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PricingExpression buildPricingExpression() {
  ...
  if (buildCounterPricingExpression < 3) {
    ...
    o.tieredRates = buildUnnamed3026();
    o.usageUnit = 'foo';
...
void checkPricingExpression(api.PricingExpression o) {
  ...
  if (buildCounterPricingExpression < 3) {
    ...
    checkUnnamed3026(o.tieredRates!);
    unittest.expect(
      o.usageUnit!,
      unittest.equals('foo'),
    );
...
core.List<api.PricingInfo> buildUnnamed3027() {
  var o = <api.PricingInfo>[];
...
void checkUnnamed3027(core.List<api.PricingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Sku buildSku() {
  ...
  if (buildCounterSku < 3) {
    ...
    o.name = 'foo';
    o.pricingInfo = buildUnnamed3027();
    o.serviceProviderName = 'foo';
    o.serviceRegions = buildUnnamed3028();
    o.skuId = 'foo';
  }
  buildCounterSku--;
  return o;
...
void checkSku(api.Sku o) {
  ...
  if (buildCounterSku < 3) {
    ...
    checkUnnamed3027(o.pricingInfo!);
    unittest.expect(
      o.serviceProviderName!,
      unittest.equals('foo'),
    );
    checkUnnamed3028(o.serviceRegions!);
    unittest.expect(
      o.skuId!,
      unittest.equals('foo'),
    );
