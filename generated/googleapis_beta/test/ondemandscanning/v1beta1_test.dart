...
core.List<api.PackageData> buildUnnamed8790() {
...
void checkUnnamed8790(core.List<api.PackageData> o) {
...
void checkArtifact(api.Artifact o) {
  ...
  if (buildCounterArtifact < 3) {
    ...
    checkUnnamed8791(o.names!);
  }
  buildCounterArtifact--;
}

core.List<api.Jwt> buildUnnamed8792() {
  var o = <api.Jwt>[];
  o.add(buildJwt());
  o.add(buildJwt());
  return o;
...
void checkUnnamed8792(core.List<api.Jwt> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJwt(o[0] as api.Jwt);
  checkJwt(o[1] as api.Jwt);
}

core.List<api.Signature> buildUnnamed8793() {
  var o = <api.Signature>[];
...
void checkUnnamed8793(core.List<api.Signature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AttestationOccurrence buildAttestationOccurrence() {
  ...
  if (buildCounterAttestationOccurrence < 3) {
    o.jwts = buildUnnamed8792();
    o.serializedPayload = 'foo';
    o.signatures = buildUnnamed8793();
  }
  buildCounterAttestationOccurrence--;
  return o;
}
...
void checkAttestationOccurrence(api.AttestationOccurrence o) {
  buildCounterAttestationOccurrence++;
  if (buildCounterAttestationOccurrence < 3) {
    checkUnnamed8792(o.jwts!);
    unittest.expect(
      o.serializedPayload!,
      unittest.equals('foo'),
    );
    checkUnnamed8793(o.signatures!);
  }
  buildCounterAttestationOccurrence--;
}
...
core.Map<core.String, core.String> buildUnnamed8794() {
...
void checkUnnamed8794(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Artifact> buildUnnamed8795() {
  var o = <api.Artifact>[];
  o.add(buildArtifact());
  o.add(buildArtifact());
  return o;
...
void checkUnnamed8795(core.List<api.Artifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArtifact(o[0] as api.Artifact);
  checkArtifact(o[1] as api.Artifact);
}

core.List<api.Command> buildUnnamed8796() {
  var o = <api.Command>[];
  o.add(buildCommand());
  o.add(buildCommand());
  return o;
...
void checkUnnamed8796(core.List<api.Command> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildProvenance buildBuildProvenance() {
  ...
  if (buildCounterBuildProvenance < 3) {
    o.buildOptions = buildUnnamed8794();
    o.builderVersion = 'foo';
    o.builtArtifacts = buildUnnamed8795();
    o.commands = buildUnnamed8796();
    o.createTime = 'foo';
    o.creator = 'foo';
    o.endTime = 'foo';
    o.id = 'foo';
...
void checkBuildProvenance(api.BuildProvenance o) {
  buildCounterBuildProvenance++;
  if (buildCounterBuildProvenance < 3) {
    checkUnnamed8794(o.buildOptions!);
    unittest.expect(
      o.builderVersion!,
      unittest.equals('foo'),
    );
    checkUnnamed8795(o.builtArtifacts!);
    checkUnnamed8796(o.commands!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
api.Command buildCommand() {
  ...
  if (buildCounterCommand < 3) {
    o.args = buildUnnamed8797();
    o.dir = 'foo';
    o.env = buildUnnamed8798();
    o.id = 'foo';
    o.name = 'foo';
    o.waitFor = buildUnnamed8799();
  }
  buildCounterCommand--;
  return o;
}
...
void checkCommand(api.Command o) {
  buildCounterCommand++;
  if (buildCounterCommand < 3) {
    checkUnnamed8797(o.args!);
    unittest.expect(
      o.dir!,
      unittest.equals('foo'),
    );
    checkUnnamed8798(o.env!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8799(o.waitFor!);
  }
  buildCounterCommand--;
}

core.List<api.NonCompliantFile> buildUnnamed8800() {
...
void checkUnnamed8800(core.List<api.NonCompliantFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ComplianceOccurrence buildComplianceOccurrence() {
  ...
  if (buildCounterComplianceOccurrence < 3) {
    ...
    o.nonCompliantFiles = buildUnnamed8800();
  }
  buildCounterComplianceOccurrence--;
  return o;
}
...
void checkComplianceOccurrence(api.ComplianceOccurrence o) {
  ...
  if (buildCounterComplianceOccurrence < 3) {
    ...
    checkUnnamed8800(o.nonCompliantFiles!);
  }
  buildCounterComplianceOccurrence--;
}
...
api.DeploymentOccurrence buildDeploymentOccurrence() {
  ...
  if (buildCounterDeploymentOccurrence < 3) {
    ...
    o.deployTime = 'foo';
    o.platform = 'foo';
    o.resourceUri = buildUnnamed8801();
    o.undeployTime = 'foo';
    o.userEmail = 'foo';
  }
  buildCounterDeploymentOccurrence--;
...
void checkDeploymentOccurrence(api.DeploymentOccurrence o) {
  ...
  if (buildCounterDeploymentOccurrence < 3) {
    ...
    checkUnnamed8801(o.resourceUri!);
    unittest.expect(
      o.undeployTime!,
      unittest.equals('foo'),
    );
...
core.List<api.Hash> buildUnnamed8802() {
  var o = <api.Hash>[];
  o.add(buildHash());
  o.add(buildHash());
  return o;
...
void checkUnnamed8802(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkFileHashes(api.FileHashes o) {
  buildCounterFileHashes++;
  if (buildCounterFileHashes < 3) {
    checkUnnamed8802(o.fileHash!);
  }
  buildCounterFileHashes--;
}

core.List<core.String> buildUnnamed8803() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8803(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Layer> buildUnnamed8804() {
  var o = <api.Layer>[];
  o.add(buildLayer());
  o.add(buildLayer());
  return o;
...
void checkUnnamed8804(core.List<api.Layer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed8805() {
  var o = <api.Operation>[];
...
void checkUnnamed8805(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed8805(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Occurrence> buildUnnamed8806() {
...
void checkUnnamed8806(core.List<api.Occurrence> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListVulnerabilitiesResponse(api.ListVulnerabilitiesResponse o) {
  ...
  if (buildCounterListVulnerabilitiesResponse < 3) {
    ...
    checkUnnamed8806(o.occurrences!);
  }
  buildCounterListVulnerabilitiesResponse--;
}
...
core.Map<core.String, core.Object> buildUnnamed8807() {
...
void checkUnnamed8807(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed8807();
    o.name = 'foo';
    o.response = buildUnnamed8808();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed8807(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8808(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.Location> buildUnnamed8809() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed8809(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SourceContext> buildUnnamed8810() {
...
void checkUnnamed8810(core.List<api.SourceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSourceContext(o[0] as api.SourceContext);
  checkSourceContext(o[1] as api.SourceContext);
}

core.Map<core.String, api.FileHashes> buildUnnamed8811() {
...
void checkUnnamed8811(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Source buildSource() {
  ...
  if (buildCounterSource < 3) {
    o.additionalContexts = buildUnnamed8810();
    o.artifactStorageSourceUri = 'foo';
    o.context = buildSourceContext();
    o.fileHashes = buildUnnamed8811();
  }
  buildCounterSource--;
  return o;
}
...
void checkSource(api.Source o) {
  buildCounterSource++;
  if (buildCounterSource < 3) {
    checkUnnamed8810(o.additionalContexts!);
    unittest.expect(
      o.artifactStorageSourceUri!,
      unittest.equals('foo'),
    );
    checkSourceContext(o.context! as api.SourceContext);
    checkUnnamed8811(o.fileHashes!);
  }
  buildCounterSource--;
}

core.Map<core.String, core.String> buildUnnamed8812() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed8812(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
void checkSourceContext(api.SourceContext o) {
  ...
  if (buildCounterSourceContext < 3) {
    ...
    checkUnnamed8812(o.labels!);
  }
  buildCounterSourceContext--;
}

core.Map<core.String, core.Object> buildUnnamed8813() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed8813(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8814() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed8813());
  o.add(buildUnnamed8813());
  return o;
}

void checkUnnamed8814(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8813(o[0]);
  checkUnnamed8813(o[1]);
}
...
core.List<api.PackageIssue> buildUnnamed8816() {
  var o = <api.PackageIssue>[];
...
void checkUnnamed8816(core.List<api.PackageIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackageIssue(o[0] as api.PackageIssue);
  checkPackageIssue(o[1] as api.PackageIssue);
}

core.List<api.RelatedUrl> buildUnnamed8817() {
  var o = <api.RelatedUrl>[];
...
void checkUnnamed8817(core.List<api.RelatedUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VulnerabilityOccurrence buildVulnerabilityOccurrence() {
  ...
  if (buildCounterVulnerabilityOccurrence < 3) {
    ...
    o.packageIssue = buildUnnamed8816();
    o.relatedUrls = buildUnnamed8817();
    o.severity = 'foo';
...
void checkVulnerabilityOccurrence(api.VulnerabilityOccurrence o) {
  ...
  if (buildCounterVulnerabilityOccurrence < 3) {
    ...
    checkUnnamed8816(o.packageIssue!);
    checkUnnamed8817(o.relatedUrls!);
    unittest.expect(
      o.severity!,
      unittest.equals('foo'),
    );
...
core.List<api.Category> buildUnnamed8818() {
  var o = <api.Category>[];
  o.add(buildCategory());
  o.add(buildCategory());
  return o;
...
void checkUnnamed8818(core.List<api.Category> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WindowsUpdate buildWindowsUpdate() {
  ...
  if (buildCounterWindowsUpdate < 3) {
    o.categories = buildUnnamed8818();
    o.description = 'foo';
    o.identity = buildIdentity();
    o.kbArticleIds = buildUnnamed8819();
...
void checkWindowsUpdate(api.WindowsUpdate o) {
  buildCounterWindowsUpdate++;
  if (buildCounterWindowsUpdate < 3) {
    checkUnnamed8818(o.categories!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
    checkIdentity(o.identity! as api.Identity);
    checkUnnamed8819(o.kbArticleIds!);
    unittest.expect(
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsScansResource', () {
    unittest.test('method--analyzePackages', () async {
      ...
      var arg_request = buildAnalyzePackagesRequest();
      var arg_parent = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = api.AnalyzePackagesRequest.fromJson(
            json as core.Map<core.String, core.dynamic>);
        checkAnalyzePackagesRequest(obj as api.AnalyzePackagesRequest);
  ...
  unittest.group('resource-ProjectsLocationsScansVulnerabilitiesResource', () {
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        var resp = convert.json.encode(buildListVulnerabilitiesResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
