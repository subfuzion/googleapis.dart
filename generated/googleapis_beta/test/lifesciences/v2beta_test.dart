...
core.Map<core.String, core.String> buildUnnamed8726() {
...
void checkUnnamed8726(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed8727() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed8727(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Mount> buildUnnamed8728() {
  var o = <api.Mount>[];
  o.add(buildMount());
  o.add(buildMount());
  return o;
...
void checkUnnamed8728(core.List<api.Mount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMount(o[0] as api.Mount);
  checkMount(o[1] as api.Mount);
}

core.Map<core.String, core.int> buildUnnamed8729() {
...
void checkUnnamed8729(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals(42),
...
api.Action buildAction() {
  ...
  if (buildCounterAction < 3) {
    ...
    o.entrypoint = 'foo';
    o.environment = buildUnnamed8726();
    o.ignoreExitStatus = true;
    o.imageUri = 'foo';
    o.labels = buildUnnamed8727();
    o.mounts = buildUnnamed8728();
    o.pidNamespace = 'foo';
    o.portMappings = buildUnnamed8729();
...
void checkAction(api.Action o) {
  ...
  if (buildCounterAction < 3) {
    ...
    checkUnnamed8726(o.environment!);
    unittest.expect(o.ignoreExitStatus!, unittest.isTrue);
    unittest.expect(
      o.imageUri!,
      unittest.equals('foo'),
    );
    checkUnnamed8727(o.labels!);
    checkUnnamed8728(o.mounts!);
    unittest.expect(
      o.pidNamespace!,
      unittest.equals('foo'),
    );
    checkUnnamed8729(o.portMappings!);
...
core.Map<core.String, core.int> buildUnnamed8730() {
  var o = <core.String, core.int>{};
  o['x'] = 42;
  o['y'] = 42;
  return o;
...
void checkUnnamed8730(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals(42),
...
api.ContainerStartedEvent buildContainerStartedEvent() {
  ...
  if (buildCounterContainerStartedEvent < 3) {
    o.actionId = 42;
    o.ipAddress = 'foo';
    o.portMappings = buildUnnamed8730();
  }
  buildCounterContainerStartedEvent--;
  return o;
}
...
void checkContainerStartedEvent(api.ContainerStartedEvent o) {
  ...
  if (buildCounterContainerStartedEvent < 3) {
    ...
    checkUnnamed8730(o.portMappings!);
  }
  buildCounterContainerStartedEvent--;
}
...
core.List<api.Location> buildUnnamed8732() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed8732(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed8733() {
  var o = <api.Operation>[];
...
void checkUnnamed8733(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed8733(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.Map<core.String, core.String> buildUnnamed8734() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed8734(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed8735() {
...
void checkUnnamed8735(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed8734();
    o.locationId = 'foo';
    o.metadata = buildUnnamed8735();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed8734(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed8735(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Event> buildUnnamed8736() {
  var o = <api.Event>[];
  o.add(buildEvent());
  o.add(buildEvent());
  return o;
...
void checkUnnamed8736(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Metadata buildMetadata() {
  ...
  if (buildCounterMetadata < 3) {
    o.createTime = 'foo';
    o.endTime = 'foo';
    o.events = buildUnnamed8736();
    o.labels = buildUnnamed8737();
...
void checkMetadata(api.Metadata o) {
  ...
  if (buildCounterMetadata < 3) {
    ...
    checkUnnamed8736(o.events!);
    checkUnnamed8737(o.labels!);
...
core.Map<core.String, core.Object> buildUnnamed8738() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed8738(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed8738();
    o.name = 'foo';
    o.response = buildUnnamed8739();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed8738(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8739(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.Action> buildUnnamed8740() {
  var o = <api.Action>[];
  o.add(buildAction());
  o.add(buildAction());
  return o;
...
void checkUnnamed8740(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Pipeline buildPipeline() {
  ...
  if (buildCounterPipeline < 3) {
    o.actions = buildUnnamed8740();
    o.encryptedEnvironment = buildSecret();
    o.environment = buildUnnamed8741();
...
void checkPipeline(api.Pipeline o) {
  buildCounterPipeline++;
  if (buildCounterPipeline < 3) {
    checkUnnamed8740(o.actions!);
    checkSecret(o.encryptedEnvironment! as api.Secret);
    checkUnnamed8741(o.environment!);
...
api.Resources buildResources() {
  ...
  if (buildCounterResources < 3) {
    o.regions = buildUnnamed8742();
    o.virtualMachine = buildVirtualMachine();
    o.zones = buildUnnamed8743();
  }
  buildCounterResources--;
  return o;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8747() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed8746());
  o.add(buildUnnamed8746());
  return o;
}

void checkUnnamed8747(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8746(o[0]);
  checkUnnamed8746(o[1]);
}
...
core.List<api.Accelerator> buildUnnamed8748() {
  var o = <api.Accelerator>[];
...
void checkUnnamed8748(core.List<api.Accelerator> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccelerator(o[0] as api.Accelerator);
  checkAccelerator(o[1] as api.Accelerator);
}

core.List<api.Disk> buildUnnamed8749() {
  var o = <api.Disk>[];
  o.add(buildDisk());
  o.add(buildDisk());
  return o;
...
void checkUnnamed8749(core.List<api.Disk> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Volume> buildUnnamed8752() {
  var o = <api.Volume>[];
  o.add(buildVolume());
  o.add(buildVolume());
  return o;
...
void checkUnnamed8752(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VirtualMachine buildVirtualMachine() {
  ...
  if (buildCounterVirtualMachine < 3) {
    o.accelerators = buildUnnamed8748();
    o.bootDiskSizeGb = 42;
    o.bootImage = 'foo';
    o.cpuPlatform = 'foo';
    o.disks = buildUnnamed8749();
    o.dockerCacheImages = buildUnnamed8750();
...
void checkVirtualMachine(api.VirtualMachine o) {
  buildCounterVirtualMachine++;
  if (buildCounterVirtualMachine < 3) {
    checkUnnamed8748(o.accelerators!);
    unittest.expect(
      o.bootDiskSizeGb!,
      unittest.equals(42),
    );
    ...
    checkUnnamed8749(o.disks!);
    checkUnnamed8750(o.dockerCacheImages!);
