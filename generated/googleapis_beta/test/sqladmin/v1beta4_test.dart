...
core.List<api.BackupRun> buildUnnamed8075() {
  var o = <api.BackupRun>[];
...
void checkUnnamed8075(core.List<api.BackupRun> o) {
...
core.List<api.IpMapping> buildUnnamed8076() {
  var o = <api.IpMapping>[];
...
void checkUnnamed8076(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DatabaseInstance buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.gceZone = 'foo';
    o.instanceType = 'foo';
    o.ipAddresses = buildUnnamed8076();
    o.ipv6Address = 'foo';
    o.kind = 'foo';
    ...
    o.replicaNames = buildUnnamed8077();
    o.rootPassword = 'foo';
    o.satisfiesPzs = true;
    ...
    o.state = 'foo';
    o.suspensionReason = buildUnnamed8078();
  }
  buildCounterDatabaseInstance--;
  return o;
}
...
void checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed8076(o.ipAddresses!);
    unittest.expect(
      o.ipv6Address!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8077(o.replicaNames!);
    unittest.expect(
      o.rootPassword!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8078(o.suspensionReason!);
  }
  buildCounterDatabaseInstance--;
}

core.List<api.Database> buildUnnamed8079() {
  var o = <api.Database>[];
  o.add(buildDatabase());
  o.add(buildDatabase());
  return o;
...
void checkUnnamed8079(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed8080() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8080(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.Flag buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedIntValues = buildUnnamed8082();
    o.allowedStringValues = buildUnnamed8083();
    o.appliesTo = buildUnnamed8084();
    o.inBeta = true;
    o.kind = 'foo';
    o.maxValue = 'foo';
    o.minValue = 'foo';
...
void checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed8082(o.allowedIntValues!);
    checkUnnamed8083(o.allowedStringValues!);
    checkUnnamed8084(o.appliesTo!);
...
core.List<api.Flag> buildUnnamed8085() {
  var o = <api.Flag>[];
  o.add(buildFlag());
  o.add(buildFlag());
  return o;
...
void checkUnnamed8085(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DatabaseInstance> buildUnnamed8087() {
  var o = <api.DatabaseInstance>[];
...
void checkUnnamed8088(core.List<api.ApiWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InstancesListResponse buildInstancesListResponse() {
  ...
  if (buildCounterInstancesListResponse < 3) {
    o.items = buildUnnamed8087();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.warnings = buildUnnamed8088();
  }
  buildCounterInstancesListResponse--;
  return o;
}
...
void checkInstancesListResponse(api.InstancesListResponse o) {
  ...
  if (buildCounterInstancesListResponse < 3) {
    ...
    checkUnnamed8088(o.warnings!);
  }
  buildCounterInstancesListResponse--;
}

core.List<api.SslCert> buildUnnamed8089() {
  var o = <api.SslCert>[];
  o.add(buildSslCert());
  o.add(buildSslCert());
  return o;
...
void checkUnnamed8089(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AclEntry> buildUnnamed8090() {
  var o = <api.AclEntry>[];
  o.add(buildAclEntry());
  o.add(buildAclEntry());
  return o;
...
void checkUnnamed8090(core.List<api.AclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IpConfiguration buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed8090();
    o.ipv4Enabled = true;
...
void checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed8090(o.authorizedNetworks!);
...
core.List<api.OperationError> buildUnnamed8091() {
  var o = <api.OperationError>[];
...
void checkUnnamed8091(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed8092() {
  var o = <api.Operation>[];
...
void checkUnnamed8092(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed8093() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8093(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.DatabaseFlags> buildUnnamed8094() {
  var o = <api.DatabaseFlags>[];
...
void checkUnnamed8094(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabaseFlags(o[0] as api.DatabaseFlags);
  checkDatabaseFlags(o[1] as api.DatabaseFlags);
}

core.List<api.DenyMaintenancePeriod> buildUnnamed8095() {
  var o = <api.DenyMaintenancePeriod>[];
...
void checkUnnamed8096(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Settings buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed8093();
    ...
    o.dataDiskType = 'foo';
    o.databaseFlags = buildUnnamed8094();
    o.databaseReplicationEnabled = true;
    o.denyMaintenancePeriods = buildUnnamed8095();
...
void checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed8093(o.authorizedGaeApplications!);
    unittest.expect(
      o.availabilityType!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8094(o.databaseFlags!);
    unittest.expect(o.databaseReplicationEnabled!, unittest.isTrue);
    checkUnnamed8095(o.denyMaintenancePeriods!);
...
core.List<api.SqlExternalSyncSettingError> buildUnnamed8097() {
  var o = <api.SqlExternalSyncSettingError>[];
...
void checkUnnamed8097(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SqlExternalSyncSettingError> buildUnnamed8098() {
  var o = <api.SqlExternalSyncSettingError>[];
  o.add(buildSqlExternalSyncSettingError());
  o.add(buildSqlExternalSyncSettingError());
  return o;
...
void checkUnnamed8098(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSqlExternalSyncSettingError(o[0] as api.SqlExternalSyncSettingError);
  checkSqlExternalSyncSettingError(o[1] as api.SqlExternalSyncSettingError);
}
...
api.SqlInstancesVerifyExternalSyncSettingsResponse
  ...
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    o.errors = buildUnnamed8097();
    o.kind = 'foo';
    o.warnings = buildUnnamed8098();
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
  return o;
}
...
void checkSqlInstancesVerifyExternalSyncSettingsResponse(
  ...
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse++;
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    checkUnnamed8097(o.errors!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed8098(o.warnings!);
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
}
...
api.SqlServerUserDetails buildSqlServerUserDetails() {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    o.disabled = true;
    o.serverRoles = buildUnnamed8099();
  }
  buildCounterSqlServerUserDetails--;
  return o;
}
...
void checkSqlServerUserDetails(api.SqlServerUserDetails o) {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    ...
    checkUnnamed8099(o.serverRoles!);
  }
  buildCounterSqlServerUserDetails--;
}
...
core.List<api.SslCert> buildUnnamed8100() {
  var o = <api.SslCert>[];
  o.add(buildSslCert());
  o.add(buildSslCert());
  return o;
...
void checkUnnamed8100(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0] as api.SslCert);
  checkSslCert(o[1] as api.SslCert);
}
...
core.List<api.Tier> buildUnnamed8102() {
  var o = <api.Tier>[];
  o.add(buildTier());
  o.add(buildTier());
  return o;
...
void checkUnnamed8102(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.User> buildUnnamed8103() {
  var o = <api.User>[];
  o.add(buildUser());
  o.add(buildUser());
  return o;
...
void checkUnnamed8103(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
