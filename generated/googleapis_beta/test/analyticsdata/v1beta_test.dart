...
core.List<api.RunPivotReportRequest> buildUnnamed8397() {
...
void checkUnnamed8397(core.List<api.RunPivotReportRequest> o) {
...
void checkBatchRunPivotReportsRequest(api.BatchRunPivotReportsRequest o) {
  buildCounterBatchRunPivotReportsRequest++;
  if (buildCounterBatchRunPivotReportsRequest < 3) {
    checkUnnamed8397(o.requests!);
  }
  buildCounterBatchRunPivotReportsRequest--;
}

core.List<api.RunPivotReportResponse> buildUnnamed8398() {
...
void checkUnnamed8398(core.List<api.RunPivotReportResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BatchRunPivotReportsResponse buildBatchRunPivotReportsResponse() {
  ...
  if (buildCounterBatchRunPivotReportsResponse < 3) {
    o.kind = 'foo';
    o.pivotReports = buildUnnamed8398();
  }
  buildCounterBatchRunPivotReportsResponse--;
  return o;
}
...
void checkBatchRunPivotReportsResponse(api.BatchRunPivotReportsResponse o) {
  ...
  if (buildCounterBatchRunPivotReportsResponse < 3) {
    ...
    checkUnnamed8398(o.pivotReports!);
  }
  buildCounterBatchRunPivotReportsResponse--;
}

core.List<api.RunReportRequest> buildUnnamed8399() {
...
void checkUnnamed8399(core.List<api.RunReportRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchRunReportsRequest(api.BatchRunReportsRequest o) {
  buildCounterBatchRunReportsRequest++;
  if (buildCounterBatchRunReportsRequest < 3) {
    checkUnnamed8399(o.requests!);
  }
  buildCounterBatchRunReportsRequest--;
}

core.List<api.RunReportResponse> buildUnnamed8400() {
...
void checkUnnamed8400(core.List<api.RunReportResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Cohort> buildUnnamed8401() {
  var o = <api.Cohort>[];
  o.add(buildCohort());
  o.add(buildCohort());
  return o;
...
void checkUnnamed8401(core.List<api.Cohort> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ConcatenateExpression buildConcatenateExpression() {
  ...
  if (buildCounterConcatenateExpression < 3) {
    o.delimiter = 'foo';
    o.dimensionNames = buildUnnamed8402();
  }
  buildCounterConcatenateExpression--;
  return o;
}
...
void checkConcatenateExpression(api.ConcatenateExpression o) {
  ...
  if (buildCounterConcatenateExpression < 3) {
    ...
    checkUnnamed8402(o.dimensionNames!);
  }
  buildCounterConcatenateExpression--;
}
...
core.List<core.String> buildUnnamed8403() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8403(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.DimensionMetadata buildDimensionMetadata() {
  ...
  if (buildCounterDimensionMetadata < 3) {
    ...
    o.deprecatedApiNames = buildUnnamed8403();
    o.description = 'foo';
    o.uiName = 'foo';
  }
  buildCounterDimensionMetadata--;
...
void checkDimensionMetadata(api.DimensionMetadata o) {
  ...
  if (buildCounterDimensionMetadata < 3) {
    ...
    checkUnnamed8403(o.deprecatedApiNames!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
...
core.List<api.FilterExpression> buildUnnamed8404() {
  var o = <api.FilterExpression>[];
...
void checkUnnamed8404(core.List<api.FilterExpression> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FilterExpressionList buildFilterExpressionList() {
  ...
  if (buildCounterFilterExpressionList < 3) {
    o.expressions = buildUnnamed8404();
  }
  buildCounterFilterExpressionList--;
  return o;
}
...
void checkFilterExpressionList(api.FilterExpressionList o) {
  buildCounterFilterExpressionList++;
  if (buildCounterFilterExpressionList < 3) {
    checkUnnamed8404(o.expressions!);
  }
  buildCounterFilterExpressionList--;
}
...
void checkInListFilter(api.InListFilter o) {
  ...
  if (buildCounterInListFilter < 3) {
    ...
    checkUnnamed8405(o.values!);
  }
  buildCounterInListFilter--;
}

core.List<api.DimensionMetadata> buildUnnamed8406() {
  var o = <api.DimensionMetadata>[];
...
void checkUnnamed8407(core.List<api.MetricMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Metadata buildMetadata() {
  ...
  if (buildCounterMetadata < 3) {
    o.dimensions = buildUnnamed8406();
    o.metrics = buildUnnamed8407();
    o.name = 'foo';
  }
  buildCounterMetadata--;
  return o;
...
void checkMetadata(api.Metadata o) {
  buildCounterMetadata++;
  if (buildCounterMetadata < 3) {
    checkUnnamed8406(o.dimensions!);
    checkUnnamed8407(o.metrics!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.MetricMetadata buildMetricMetadata() {
  ...
  if (buildCounterMetricMetadata < 3) {
    o.apiName = 'foo';
    o.customDefinition = true;
    o.deprecatedApiNames = buildUnnamed8408();
    o.description = 'foo';
    o.expression = 'foo';
    o.type = 'foo';
    o.uiName = 'foo';
...
void checkMetricMetadata(api.MetricMetadata o) {
  ...
  if (buildCounterMetricMetadata < 3) {
    ...
    unittest.expect(o.customDefinition!, unittest.isTrue);
    checkUnnamed8408(o.deprecatedApiNames!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
...
core.List<api.OrderBy> buildUnnamed8411() {
  var o = <api.OrderBy>[];
  o.add(buildOrderBy());
  o.add(buildOrderBy());
  return o;
...
void checkUnnamed8411(core.List<api.OrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Pivot buildPivot() {
  ...
  if (buildCounterPivot < 3) {
    o.fieldNames = buildUnnamed8409();
    o.limit = 'foo';
    o.metricAggregations = buildUnnamed8410();
    o.offset = 'foo';
    o.orderBys = buildUnnamed8411();
  }
  buildCounterPivot--;
  return o;
}
...
void checkPivot(api.Pivot o) {
  buildCounterPivot++;
  if (buildCounterPivot < 3) {
    checkUnnamed8409(o.fieldNames!);
    unittest.expect(
      o.limit!,
      unittest.equals('foo'),
    );
    checkUnnamed8410(o.metricAggregations!);
    unittest.expect(
      o.offset!,
      unittest.equals('foo'),
    );
    checkUnnamed8411(o.orderBys!);
  }
  buildCounterPivot--;
}

core.List<api.DimensionValue> buildUnnamed8412() {
  var o = <api.DimensionValue>[];
...
void checkUnnamed8412(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PivotDimensionHeader buildPivotDimensionHeader() {
  ...
  if (buildCounterPivotDimensionHeader < 3) {
    o.dimensionValues = buildUnnamed8412();
  }
  buildCounterPivotDimensionHeader--;
  return o;
}
...
void checkPivotDimensionHeader(api.PivotDimensionHeader o) {
  buildCounterPivotDimensionHeader++;
  if (buildCounterPivotDimensionHeader < 3) {
    checkUnnamed8412(o.dimensionValues!);
  }
  buildCounterPivotDimensionHeader--;
}

core.List<api.PivotDimensionHeader> buildUnnamed8413() {
  var o = <api.PivotDimensionHeader>[];
...
void checkUnnamed8413(core.List<api.PivotDimensionHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PivotHeader buildPivotHeader() {
  ...
  if (buildCounterPivotHeader < 3) {
    o.pivotDimensionHeaders = buildUnnamed8413();
    o.rowCount = 42;
  }
  buildCounterPivotHeader--;
  return o;
...
void checkPivotHeader(api.PivotHeader o) {
  buildCounterPivotHeader++;
  if (buildCounterPivotHeader < 3) {
    checkUnnamed8413(o.pivotDimensionHeaders!);
    unittest.expect(
      o.rowCount!,
      unittest.equals(42),
    );
...
core.List<api.PivotSelection> buildUnnamed8414() {
...
void checkUnnamed8414(core.List<api.PivotSelection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PivotOrderBy buildPivotOrderBy() {
  ...
  if (buildCounterPivotOrderBy < 3) {
    o.metricName = 'foo';
    o.pivotSelections = buildUnnamed8414();
  }
  buildCounterPivotOrderBy--;
  return o;
}
...
void checkPivotOrderBy(api.PivotOrderBy o) {
  ...
  if (buildCounterPivotOrderBy < 3) {
    ...
    checkUnnamed8414(o.pivotSelections!);
  }
  buildCounterPivotOrderBy--;
}
...
core.List<api.DimensionValue> buildUnnamed8415() {
  var o = <api.DimensionValue>[];
  o.add(buildDimensionValue());
  o.add(buildDimensionValue());
  return o;
...
void checkUnnamed8415(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionValue(o[0] as api.DimensionValue);
  checkDimensionValue(o[1] as api.DimensionValue);
}

core.List<api.MetricValue> buildUnnamed8416() {
  var o = <api.MetricValue>[];
...
void checkUnnamed8416(core.List<api.MetricValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Row buildRow() {
  ...
  if (buildCounterRow < 3) {
    o.dimensionValues = buildUnnamed8415();
    o.metricValues = buildUnnamed8416();
  }
  buildCounterRow--;
  return o;
}
...
void checkRow(api.Row o) {
  buildCounterRow++;
  if (buildCounterRow < 3) {
    checkUnnamed8415(o.dimensionValues!);
    checkUnnamed8416(o.metricValues!);
  }
  buildCounterRow--;
}

core.List<api.DateRange> buildUnnamed8417() {
  var o = <api.DateRange>[];
...
void checkUnnamed8417(core.List<api.DateRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRange(o[0] as api.DateRange);
  checkDateRange(o[1] as api.DateRange);
}

core.List<api.Dimension> buildUnnamed8418() {
  var o = <api.Dimension>[];
...
void checkUnnamed8418(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0] as api.Dimension);
  checkDimension(o[1] as api.Dimension);
}

core.List<api.Metric> buildUnnamed8419() {
  var o = <api.Metric>[];
  o.add(buildMetric());
  o.add(buildMetric());
  return o;
...
void checkUnnamed8419(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0] as api.Metric);
  checkMetric(o[1] as api.Metric);
}

core.List<api.Pivot> buildUnnamed8420() {
  var o = <api.Pivot>[];
  o.add(buildPivot());
  o.add(buildPivot());
  return o;
...
void checkUnnamed8420(core.List<api.Pivot> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RunPivotReportRequest buildRunPivotReportRequest() {
  ...
  if (buildCounterRunPivotReportRequest < 3) {
    ...
    o.currencyCode = 'foo';
    o.dateRanges = buildUnnamed8417();
    o.dimensionFilter = buildFilterExpression();
    o.dimensions = buildUnnamed8418();
    o.keepEmptyRows = true;
    o.metricFilter = buildFilterExpression();
    o.metrics = buildUnnamed8419();
    o.pivots = buildUnnamed8420();
    o.property = 'foo';
...
core.List<api.Row> buildUnnamed8421() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8421(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}

core.List<api.DimensionHeader> buildUnnamed8422() {
  var o = <api.DimensionHeader>[];
...
void checkUnnamed8422(core.List<api.DimensionHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionHeader(o[0] as api.DimensionHeader);
  checkDimensionHeader(o[1] as api.DimensionHeader);
}

core.List<api.MetricHeader> buildUnnamed8423() {
  var o = <api.MetricHeader>[];
...
void checkUnnamed8423(core.List<api.MetricHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricHeader(o[0] as api.MetricHeader);
  checkMetricHeader(o[1] as api.MetricHeader);
}

core.List<api.PivotHeader> buildUnnamed8424() {
  var o = <api.PivotHeader>[];
...
void checkUnnamed8424(core.List<api.PivotHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RunPivotReportResponse buildRunPivotReportResponse() {
  ...
  if (buildCounterRunPivotReportResponse < 3) {
    o.aggregates = buildUnnamed8421();
    o.dimensionHeaders = buildUnnamed8422();
    o.kind = 'foo';
    o.metadata = buildResponseMetaData();
    o.metricHeaders = buildUnnamed8423();
    o.pivotHeaders = buildUnnamed8424();
    o.propertyQuota = buildPropertyQuota();
    o.rows = buildUnnamed8425();
  }
  buildCounterRunPivotReportResponse--;
  return o;
}
...
void checkRunPivotReportResponse(api.RunPivotReportResponse o) {
  buildCounterRunPivotReportResponse++;
  if (buildCounterRunPivotReportResponse < 3) {
    checkUnnamed8421(o.aggregates!);
    checkUnnamed8422(o.dimensionHeaders!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkResponseMetaData(o.metadata! as api.ResponseMetaData);
    checkUnnamed8423(o.metricHeaders!);
    checkUnnamed8424(o.pivotHeaders!);
    checkPropertyQuota(o.propertyQuota! as api.PropertyQuota);
    checkUnnamed8425(o.rows!);
  }
  buildCounterRunPivotReportResponse--;
}

core.List<api.Dimension> buildUnnamed8426() {
  var o = <api.Dimension>[];
  o.add(buildDimension());
  o.add(buildDimension());
  return o;
...
void checkUnnamed8426(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0] as api.Dimension);
  checkDimension(o[1] as api.Dimension);
}
...
core.List<api.Metric> buildUnnamed8428() {
  var o = <api.Metric>[];
  o.add(buildMetric());
  o.add(buildMetric());
  return o;
...
void checkUnnamed8428(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0] as api.Metric);
  checkMetric(o[1] as api.Metric);
}

core.List<api.OrderBy> buildUnnamed8429() {
  var o = <api.OrderBy>[];
  o.add(buildOrderBy());
  o.add(buildOrderBy());
  return o;
...
void checkUnnamed8429(core.List<api.OrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderBy(o[0] as api.OrderBy);
  checkOrderBy(o[1] as api.OrderBy);
}
...
api.RunRealtimeReportRequest buildRunRealtimeReportRequest() {
  ...
  if (buildCounterRunRealtimeReportRequest < 3) {
    o.dimensionFilter = buildFilterExpression();
    o.dimensions = buildUnnamed8426();
    o.limit = 'foo';
    o.metricAggregations = buildUnnamed8427();
    o.metricFilter = buildFilterExpression();
    o.metrics = buildUnnamed8428();
    o.orderBys = buildUnnamed8429();
    o.returnPropertyQuota = true;
  }
  buildCounterRunRealtimeReportRequest--;
  return o;
...
void checkRunRealtimeReportRequest(api.RunRealtimeReportRequest o) {
  ...
  if (buildCounterRunRealtimeReportRequest < 3) {
    ...
    checkFilterExpression(o.metricFilter! as api.FilterExpression);
    checkUnnamed8428(o.metrics!);
    checkUnnamed8429(o.orderBys!);
    unittest.expect(o.returnPropertyQuota!, unittest.isTrue);
  }
  buildCounterRunRealtimeReportRequest--;
}

core.List<api.DimensionHeader> buildUnnamed8430() {
  var o = <api.DimensionHeader>[];
  o.add(buildDimensionHeader());
  o.add(buildDimensionHeader());
  return o;
...
void checkUnnamed8430(core.List<api.DimensionHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionHeader(o[0] as api.DimensionHeader);
  checkDimensionHeader(o[1] as api.DimensionHeader);
}

core.List<api.Row> buildUnnamed8431() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8431(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}

core.List<api.MetricHeader> buildUnnamed8432() {
  var o = <api.MetricHeader>[];
  o.add(buildMetricHeader());
  o.add(buildMetricHeader());
  return o;
...
void checkUnnamed8432(core.List<api.MetricHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricHeader(o[0] as api.MetricHeader);
  checkMetricHeader(o[1] as api.MetricHeader);
}

core.List<api.Row> buildUnnamed8433() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8433(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}

core.List<api.Row> buildUnnamed8434() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8434(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}
...
api.RunRealtimeReportResponse buildRunRealtimeReportResponse() {
  ...
  if (buildCounterRunRealtimeReportResponse < 3) {
    o.dimensionHeaders = buildUnnamed8430();
    o.kind = 'foo';
    o.maximums = buildUnnamed8431();
    o.metricHeaders = buildUnnamed8432();
    o.minimums = buildUnnamed8433();
    o.propertyQuota = buildPropertyQuota();
    o.rowCount = 42;
    o.rows = buildUnnamed8434();
    o.totals = buildUnnamed8435();
  }
  buildCounterRunRealtimeReportResponse--;
  return o;
}
...
void checkRunRealtimeReportResponse(api.RunRealtimeReportResponse o) {
  buildCounterRunRealtimeReportResponse++;
  if (buildCounterRunRealtimeReportResponse < 3) {
    checkUnnamed8430(o.dimensionHeaders!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed8431(o.maximums!);
    checkUnnamed8432(o.metricHeaders!);
    checkUnnamed8433(o.minimums!);
    checkPropertyQuota(o.propertyQuota! as api.PropertyQuota);
    unittest.expect(
      o.rowCount!,
      unittest.equals(42),
    );
    checkUnnamed8434(o.rows!);
    checkUnnamed8435(o.totals!);
  }
  buildCounterRunRealtimeReportResponse--;
}

core.List<api.DateRange> buildUnnamed8436() {
  var o = <api.DateRange>[];
  o.add(buildDateRange());
  o.add(buildDateRange());
  return o;
...
void checkUnnamed8436(core.List<api.DateRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRange(o[0] as api.DateRange);
  checkDateRange(o[1] as api.DateRange);
}

core.List<api.Dimension> buildUnnamed8437() {
  var o = <api.Dimension>[];
  o.add(buildDimension());
  o.add(buildDimension());
  return o;
...
void checkUnnamed8437(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0] as api.Dimension);
  checkDimension(o[1] as api.Dimension);
}
...
core.List<api.Metric> buildUnnamed8439() {
  var o = <api.Metric>[];
  o.add(buildMetric());
  o.add(buildMetric());
  return o;
...
void checkUnnamed8439(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0] as api.Metric);
  checkMetric(o[1] as api.Metric);
}

core.List<api.OrderBy> buildUnnamed8440() {
  var o = <api.OrderBy>[];
  o.add(buildOrderBy());
  o.add(buildOrderBy());
  return o;
...
void checkUnnamed8440(core.List<api.OrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderBy(o[0] as api.OrderBy);
  checkOrderBy(o[1] as api.OrderBy);
}
...
api.RunReportRequest buildRunReportRequest() {
  ...
  if (buildCounterRunReportRequest < 3) {
    o.cohortSpec = buildCohortSpec();
    o.currencyCode = 'foo';
    o.dateRanges = buildUnnamed8436();
    o.dimensionFilter = buildFilterExpression();
    o.dimensions = buildUnnamed8437();
    o.keepEmptyRows = true;
    o.limit = 'foo';
    o.metricAggregations = buildUnnamed8438();
    o.metricFilter = buildFilterExpression();
    o.metrics = buildUnnamed8439();
    o.offset = 'foo';
    o.orderBys = buildUnnamed8440();
    o.property = 'foo';
    o.returnPropertyQuota = true;
  }
  buildCounterRunReportRequest--;
...
void checkRunReportRequest(api.RunReportRequest o) {
  ...
  if (buildCounterRunReportRequest < 3) {
    ...
    checkUnnamed8436(o.dateRanges!);
    checkFilterExpression(o.dimensionFilter! as api.FilterExpression);
    checkUnnamed8437(o.dimensions!);
    unittest.expect(o.keepEmptyRows!, unittest.isTrue);
    unittest.expect(
      o.limit!,
      unittest.equals('foo'),
    );
    checkUnnamed8438(o.metricAggregations!);
    checkFilterExpression(o.metricFilter! as api.FilterExpression);
    checkUnnamed8439(o.metrics!);
    unittest.expect(
      o.offset!,
      unittest.equals('foo'),
    );
    checkUnnamed8440(o.orderBys!);
    unittest.expect(
      o.property!,
      unittest.equals('foo'),
    );
...
core.List<api.DimensionHeader> buildUnnamed8441() {
  var o = <api.DimensionHeader>[];
  o.add(buildDimensionHeader());
  o.add(buildDimensionHeader());
  return o;
...
void checkUnnamed8441(core.List<api.DimensionHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionHeader(o[0] as api.DimensionHeader);
  checkDimensionHeader(o[1] as api.DimensionHeader);
}
...
core.List<api.MetricHeader> buildUnnamed8443() {
  var o = <api.MetricHeader>[];
  o.add(buildMetricHeader());
  o.add(buildMetricHeader());
  return o;
...
void checkUnnamed8443(core.List<api.MetricHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricHeader(o[0] as api.MetricHeader);
  checkMetricHeader(o[1] as api.MetricHeader);
}

core.List<api.Row> buildUnnamed8444() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8444(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}
...
api.RunReportResponse buildRunReportResponse() {
  ...
  if (buildCounterRunReportResponse < 3) {
    o.dimensionHeaders = buildUnnamed8441();
    o.kind = 'foo';
    o.maximums = buildUnnamed8442();
    o.metadata = buildResponseMetaData();
    o.metricHeaders = buildUnnamed8443();
    o.minimums = buildUnnamed8444();
    o.propertyQuota = buildPropertyQuota();
    o.rowCount = 42;
    o.rows = buildUnnamed8445();
    o.totals = buildUnnamed8446();
  }
  buildCounterRunReportResponse--;
  return o;
}
...
void checkRunReportResponse(api.RunReportResponse o) {
  buildCounterRunReportResponse++;
  if (buildCounterRunReportResponse < 3) {
    checkUnnamed8441(o.dimensionHeaders!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed8442(o.maximums!);
    checkResponseMetaData(o.metadata! as api.ResponseMetaData);
    checkUnnamed8443(o.metricHeaders!);
    checkUnnamed8444(o.minimums!);
    checkPropertyQuota(o.propertyQuota! as api.PropertyQuota);
    unittest.expect(
      o.rowCount!,
      unittest.equals(42),
    );
    checkUnnamed8445(o.rows!);
    checkUnnamed8446(o.totals!);
  }
  buildCounterRunReportResponse--;
}
