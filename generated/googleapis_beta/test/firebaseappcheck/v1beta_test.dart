...
void checkGoogleFirebaseAppcheckV1betaBatchGetDeviceCheckConfigsResponse(
  ...
  if (buildCounterGoogleFirebaseAppcheckV1betaBatchGetDeviceCheckConfigsResponse <
      3) {
    checkUnnamed8684(o.configs!);
  }
  buildCounterGoogleFirebaseAppcheckV1betaBatchGetDeviceCheckConfigsResponse--;
}

core.List<api.GoogleFirebaseAppcheckV1betaRecaptchaConfig> buildUnnamed8685() {
...
core.List<api.GoogleFirebaseAppcheckV1betaService> buildUnnamed8687() {
...
void checkUnnamed8687(core.List<api.GoogleFirebaseAppcheckV1betaService> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirebaseAppcheckV1betaDebugToken> buildUnnamed8688() {
  var o = <api.GoogleFirebaseAppcheckV1betaDebugToken>[];
...
void checkUnnamed8688(core.List<api.GoogleFirebaseAppcheckV1betaDebugToken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleFirebaseAppcheckV1betaListDebugTokensResponse
  ...
  if (buildCounterGoogleFirebaseAppcheckV1betaListDebugTokensResponse < 3) {
    o.debugTokens = buildUnnamed8688();
    o.nextPageToken = 'foo';
  }
  buildCounterGoogleFirebaseAppcheckV1betaListDebugTokensResponse--;
  return o;
...
void checkGoogleFirebaseAppcheckV1betaListDebugTokensResponse(
  ...
  buildCounterGoogleFirebaseAppcheckV1betaListDebugTokensResponse++;
  if (buildCounterGoogleFirebaseAppcheckV1betaListDebugTokensResponse < 3) {
    checkUnnamed8688(o.debugTokens!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleFirebaseAppcheckV1betaService> buildUnnamed8689() {
  var o = <api.GoogleFirebaseAppcheckV1betaService>[];
  o.add(buildGoogleFirebaseAppcheckV1betaService());
  o.add(buildGoogleFirebaseAppcheckV1betaService());
  return o;
...
void checkUnnamed8689(core.List<api.GoogleFirebaseAppcheckV1betaService> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirebaseAppcheckV1betaService(
      o[0] as api.GoogleFirebaseAppcheckV1betaService);
  checkGoogleFirebaseAppcheckV1betaService(
...
core.List<api.GoogleFirebaseAppcheckV1betaPublicJwk> buildUnnamed8690() {
  var o = <api.GoogleFirebaseAppcheckV1betaPublicJwk>[];
...
void checkUnnamed8690(core.List<api.GoogleFirebaseAppcheckV1betaPublicJwk> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-ProjectsAppsDeviceCheckConfigResource', () {
    unittest.test('method--batchGet', () async {
      ...
      var arg_parent = 'foo';
      var arg_names = buildUnnamed8691();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-ProjectsAppsRecaptchaConfigResource', () {
    unittest.test('method--batchGet', () async {
      ...
      var arg_parent = 'foo';
      var arg_names = buildUnnamed8692();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
