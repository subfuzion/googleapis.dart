...
api.InstanceOSPoliciesCompliance buildInstanceOSPoliciesCompliance() {
  ...
  if (buildCounterInstanceOSPoliciesCompliance < 3) {
    ...
    o.name = 'foo';
    o.osPolicyCompliances = buildUnnamed8652();
    o.state = 'foo';
  }
  buildCounterInstanceOSPoliciesCompliance--;
  return o;
...
void checkInstanceOSPoliciesCompliance(api.InstanceOSPoliciesCompliance o) {
  ...
  if (buildCounterInstanceOSPoliciesCompliance < 3) {
    ...
    checkUnnamed8652(o.osPolicyCompliances!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<api.OSPolicyResourceCompliance> buildUnnamed8653() {
...
void checkUnnamed8653(core.List<api.OSPolicyResourceCompliance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InstanceOSPoliciesComplianceOSPolicyCompliance
  ...
  if (buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance < 3) {
    ...
    o.osPolicyId = 'foo';
    o.osPolicyResourceCompliances = buildUnnamed8653();
    o.state = 'foo';
  }
  buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance--;
  return o;
...
void checkInstanceOSPoliciesComplianceOSPolicyCompliance(
  ...
  if (buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance < 3) {
    ...
    checkUnnamed8653(o.osPolicyResourceCompliances!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.InventoryItem> buildUnnamed8654() {
...
void checkUnnamed8654(core.Map<core.String, api.InventoryItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed8656() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8656(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.InventoryWindowsUpdatePackage buildInventoryWindowsUpdatePackage() {
  ...
  if (buildCounterInventoryWindowsUpdatePackage < 3) {
    o.categories = buildUnnamed8655();
    o.description = 'foo';
    o.kbArticleIds = buildUnnamed8656();
    o.lastDeploymentChangeTime = 'foo';
    o.moreInfoUrls = buildUnnamed8657();
    o.revisionNumber = 42;
    o.supportUrl = 'foo';
    o.title = 'foo';
    o.updateId = 'foo';
...
void checkInventoryWindowsUpdatePackage(api.InventoryWindowsUpdatePackage o) {
  buildCounterInventoryWindowsUpdatePackage++;
  if (buildCounterInventoryWindowsUpdatePackage < 3) {
    checkUnnamed8655(o.categories!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
    checkUnnamed8656(o.kbArticleIds!);
    unittest.expect(
      o.lastDeploymentChangeTime!,
      unittest.equals('foo'),
    );
    checkUnnamed8657(o.moreInfoUrls!);
    unittest.expect(
      o.revisionNumber!,
      unittest.equals(42),
    );
...
core.List<api.InstanceOSPoliciesCompliance> buildUnnamed8658() {
  var o = <api.InstanceOSPoliciesCompliance>[];
...
void checkUnnamed8658(core.List<api.InstanceOSPoliciesCompliance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInstanceOSPoliciesCompliancesResponse
  ...
  if (buildCounterListInstanceOSPoliciesCompliancesResponse < 3) {
    o.instanceOsPoliciesCompliances = buildUnnamed8658();
    o.nextPageToken = 'foo';
  }
  buildCounterListInstanceOSPoliciesCompliancesResponse--;
  return o;
...
void checkListInstanceOSPoliciesCompliancesResponse(
  ...
  buildCounterListInstanceOSPoliciesCompliancesResponse++;
  if (buildCounterListInstanceOSPoliciesCompliancesResponse < 3) {
    checkUnnamed8658(o.instanceOsPoliciesCompliances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Inventory> buildUnnamed8659() {
  var o = <api.Inventory>[];
...
void checkUnnamed8659(core.List<api.Inventory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInventoriesResponse buildListInventoriesResponse() {
  ...
  if (buildCounterListInventoriesResponse < 3) {
    o.inventories = buildUnnamed8659();
    o.nextPageToken = 'foo';
  }
  buildCounterListInventoriesResponse--;
  return o;
...
void checkListInventoriesResponse(api.ListInventoriesResponse o) {
  buildCounterListInventoriesResponse++;
  if (buildCounterListInventoriesResponse < 3) {
    checkUnnamed8659(o.inventories!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.OSPolicyAssignment> buildUnnamed8660() {
...
void checkUnnamed8660(core.List<api.OSPolicyAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListOSPolicyAssignmentRevisionsResponse
  ...
  if (buildCounterListOSPolicyAssignmentRevisionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.osPolicyAssignments = buildUnnamed8660();
  }
  buildCounterListOSPolicyAssignmentRevisionsResponse--;
  return o;
}
...
void checkListOSPolicyAssignmentRevisionsResponse(
  ...
  if (buildCounterListOSPolicyAssignmentRevisionsResponse < 3) {
    ...
    checkUnnamed8660(o.osPolicyAssignments!);
  }
  buildCounterListOSPolicyAssignmentRevisionsResponse--;
}

core.List<api.OSPolicyAssignment> buildUnnamed8661() {
  var o = <api.OSPolicyAssignment>[];
  o.add(buildOSPolicyAssignment());
  o.add(buildOSPolicyAssignment());
  return o;
...
void checkUnnamed8661(core.List<api.OSPolicyAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicyAssignment(o[0] as api.OSPolicyAssignment);
  checkOSPolicyAssignment(o[1] as api.OSPolicyAssignment);
}
...
api.ListOSPolicyAssignmentsResponse buildListOSPolicyAssignmentsResponse() {
  ...
  if (buildCounterListOSPolicyAssignmentsResponse < 3) {
    o.nextPageToken = 'foo';
    o.osPolicyAssignments = buildUnnamed8661();
  }
  buildCounterListOSPolicyAssignmentsResponse--;
  return o;
}
...
void checkListOSPolicyAssignmentsResponse(
  ...
  if (buildCounterListOSPolicyAssignmentsResponse < 3) {
    ...
    checkUnnamed8661(o.osPolicyAssignments!);
  }
  buildCounterListOSPolicyAssignmentsResponse--;
}

core.List<api.VulnerabilityReport> buildUnnamed8662() {
...
void checkUnnamed8662(core.List<api.VulnerabilityReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListVulnerabilityReportsResponse buildListVulnerabilityReportsResponse() {
  ...
  if (buildCounterListVulnerabilityReportsResponse < 3) {
    o.nextPageToken = 'foo';
    o.vulnerabilityReports = buildUnnamed8662();
  }
  buildCounterListVulnerabilityReportsResponse--;
  return o;
}
...
void checkListVulnerabilityReportsResponse(
  ...
  if (buildCounterListVulnerabilityReportsResponse < 3) {
    ...
    checkUnnamed8662(o.vulnerabilityReports!);
  }
  buildCounterListVulnerabilityReportsResponse--;
}

core.List<api.OSPolicyResourceGroup> buildUnnamed8663() {
...
void checkUnnamed8663(core.List<api.OSPolicyResourceGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OSPolicy buildOSPolicy() {
  ...
  if (buildCounterOSPolicy < 3) {
    ...
    o.id = 'foo';
    o.mode = 'foo';
    o.resourceGroups = buildUnnamed8663();
  }
  buildCounterOSPolicy--;
  return o;
}
...
void checkOSPolicy(api.OSPolicy o) {
  ...
  if (buildCounterOSPolicy < 3) {
    ...
    checkUnnamed8663(o.resourceGroups!);
  }
  buildCounterOSPolicy--;
}

core.List<api.OSPolicy> buildUnnamed8664() {
  var o = <api.OSPolicy>[];
  o.add(buildOSPolicy());
  o.add(buildOSPolicy());
  return o;
...
void checkUnnamed8664(core.List<api.OSPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OSPolicyAssignmentLabelSet> buildUnnamed8665() {
...
void checkUnnamed8665(core.List<api.OSPolicyAssignmentLabelSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OSPolicyAssignmentLabelSet> buildUnnamed8666() {
  var o = <api.OSPolicyAssignmentLabelSet>[];
  o.add(buildOSPolicyAssignmentLabelSet());
  o.add(buildOSPolicyAssignmentLabelSet());
  return o;
...
void checkUnnamed8666(core.List<api.OSPolicyAssignmentLabelSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicyAssignmentLabelSet(o[0] as api.OSPolicyAssignmentLabelSet);
  checkOSPolicyAssignmentLabelSet(o[1] as api.OSPolicyAssignmentLabelSet);
}

core.List<core.String> buildUnnamed8667() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8667(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.OSPolicyAssignmentInstanceFilter buildOSPolicyAssignmentInstanceFilter() {
  ...
  if (buildCounterOSPolicyAssignmentInstanceFilter < 3) {
    o.all = true;
    o.exclusionLabels = buildUnnamed8665();
    o.inclusionLabels = buildUnnamed8666();
    o.osShortNames = buildUnnamed8667();
  }
  buildCounterOSPolicyAssignmentInstanceFilter--;
  return o;
}
...
void checkOSPolicyAssignmentInstanceFilter(
  ...
  if (buildCounterOSPolicyAssignmentInstanceFilter < 3) {
    ...
    checkUnnamed8665(o.exclusionLabels!);
    checkUnnamed8666(o.inclusionLabels!);
    checkUnnamed8667(o.osShortNames!);
  }
  buildCounterOSPolicyAssignmentInstanceFilter--;
}

core.Map<core.String, core.String> buildUnnamed8668() {
...
void checkUnnamed8668(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.OSPolicyResourceConfigStep> buildUnnamed8669() {
...
void checkUnnamed8669(core.List<api.OSPolicyResourceConfigStep> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OSPolicyResourceCompliance buildOSPolicyResourceCompliance() {
  ...
  if (buildCounterOSPolicyResourceCompliance < 3) {
    o.configSteps = buildUnnamed8669();
...
void checkOSPolicyResourceCompliance(api.OSPolicyResourceCompliance o) {
  buildCounterOSPolicyResourceCompliance++;
  if (buildCounterOSPolicyResourceCompliance < 3) {
    checkUnnamed8669(o.configSteps!);
...
core.List<api.OSPolicyResource> buildUnnamed8671() {
  var o = <api.OSPolicyResource>[];
...
void checkUnnamed8671(core.List<api.OSPolicyResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed8672() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8672(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed8675() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed8675(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed8677() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed8677(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed8676();
    o.name = 'foo';
    o.response = buildUnnamed8677();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed8676(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8677(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.VulnerabilityReportVulnerability> buildUnnamed8680() {
...
void checkUnnamed8680(core.List<api.VulnerabilityReportVulnerability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VulnerabilityReport buildVulnerabilityReport() {
  ...
  if (buildCounterVulnerabilityReport < 3) {
    o.name = 'foo';
    o.updateTime = 'foo';
    o.vulnerabilities = buildUnnamed8680();
  }
  buildCounterVulnerabilityReport--;
  return o;
}
...
void checkVulnerabilityReport(api.VulnerabilityReport o) {
  ...
  if (buildCounterVulnerabilityReport < 3) {
    ...
    checkUnnamed8680(o.vulnerabilities!);
  }
  buildCounterVulnerabilityReport--;
}
...
api.VulnerabilityReportVulnerability buildVulnerabilityReportVulnerability() {
  ...
  if (buildCounterVulnerabilityReportVulnerability < 3) {
    o.availableInventoryItemIds = buildUnnamed8681();
    o.createTime = 'foo';
    o.details = buildVulnerabilityReportVulnerabilityDetails();
    o.installedInventoryItemIds = buildUnnamed8682();
    o.updateTime = 'foo';
  }
  buildCounterVulnerabilityReportVulnerability--;
  return o;
...
void checkVulnerabilityReportVulnerability(
  ...
  buildCounterVulnerabilityReportVulnerability++;
  if (buildCounterVulnerabilityReportVulnerability < 3) {
    checkUnnamed8681(o.availableInventoryItemIds!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8682(o.installedInventoryItemIds!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
