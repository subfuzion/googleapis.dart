...
core.Map<core.String, api.GoogleIamV1Policy> buildUnnamed8321() {
...
void checkUnnamed8321(core.Map<core.String, api.GoogleIamV1Policy> o) {
...
api.GoogleCloudPolicysimulatorV1ReplayConfig
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1ReplayConfig < 3) {
    o.logSource = 'foo';
    o.policyOverlay = buildUnnamed8321();
  }
  buildCounterGoogleCloudPolicysimulatorV1ReplayConfig--;
  return o;
}
...
void checkGoogleCloudPolicysimulatorV1ReplayConfig(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1ReplayConfig < 3) {
    ...
    checkUnnamed8321(o.policyOverlay!);
  }
  buildCounterGoogleCloudPolicysimulatorV1ReplayConfig--;
}
...
api.GoogleCloudPolicysimulatorV1beta1BindingExplanation
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1BindingExplanation < 3) {
    ...
    o.memberships = buildUnnamed8322();
    o.relevance = 'foo';
    o.role = 'foo';
...
void checkGoogleCloudPolicysimulatorV1beta1BindingExplanation(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1BindingExplanation < 3) {
    ...
    checkUnnamed8322(o.memberships!);
    unittest.expect(
      o.relevance!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleRpcStatus> buildUnnamed8323() {
...
void checkUnnamed8323(core.List<api.GoogleRpcStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudPolicysimulatorV1beta1ExplainedAccess
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedAccess < 3) {
    o.accessState = 'foo';
    o.errors = buildUnnamed8323();
    o.policies = buildUnnamed8324();
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedAccess--;
  return o;
}
...
void checkGoogleCloudPolicysimulatorV1beta1ExplainedAccess(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedAccess < 3) {
    ...
    checkUnnamed8323(o.errors!);
    checkUnnamed8324(o.policies!);
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedAccess--;
}
...
api.GoogleCloudPolicysimulatorV1beta1ExplainedPolicy
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedPolicy < 3) {
    o.access = 'foo';
    o.bindingExplanations = buildUnnamed8325();
    o.fullResourceName = 'foo';
...
void checkGoogleCloudPolicysimulatorV1beta1ExplainedPolicy(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ExplainedPolicy < 3) {
    ...
    checkUnnamed8325(o.bindingExplanations!);
    unittest.expect(
      o.fullResourceName!,
      unittest.equals('foo'),
    );
...
api.GoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse <
      3) {
    o.nextPageToken = 'foo';
    o.replayResults = buildUnnamed8326();
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse--;
  return o;
}
...
void checkGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse <
    ...
    checkUnnamed8326(o.replayResults!);
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse--;
}
...
core.Map<core.String, api.GoogleIamV1Policy> buildUnnamed8327() {
  var o = <core.String, api.GoogleIamV1Policy>{};
  o['x'] = buildGoogleIamV1Policy();
  o['y'] = buildGoogleIamV1Policy();
  return o;
...
void checkUnnamed8327(core.Map<core.String, api.GoogleIamV1Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleIamV1Policy(o['x']! as api.GoogleIamV1Policy);
  checkGoogleIamV1Policy(o['y']! as api.GoogleIamV1Policy);
}
...
api.GoogleCloudPolicysimulatorV1beta1ReplayConfig
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ReplayConfig < 3) {
    o.logSource = 'foo';
    o.policyOverlay = buildUnnamed8327();
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ReplayConfig--;
  return o;
}
...
void checkGoogleCloudPolicysimulatorV1beta1ReplayConfig(
  ...
  if (buildCounterGoogleCloudPolicysimulatorV1beta1ReplayConfig < 3) {
    ...
    checkUnnamed8327(o.policyOverlay!);
  }
  buildCounterGoogleCloudPolicysimulatorV1beta1ReplayConfig--;
}
...
core.List<api.GoogleIamV1AuditLogConfig> buildUnnamed8328() {
...
void checkUnnamed8328(core.List<api.GoogleIamV1AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleIamV1AuditConfig buildGoogleIamV1AuditConfig() {
  ...
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed8328();
    o.service = 'foo';
  }
  buildCounterGoogleIamV1AuditConfig--;
  return o;
...
void checkGoogleIamV1AuditConfig(api.GoogleIamV1AuditConfig o) {
  buildCounterGoogleIamV1AuditConfig++;
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    checkUnnamed8328(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.GoogleIamV1AuditLogConfig buildGoogleIamV1AuditLogConfig() {
  ...
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed8329();
    o.logType = 'foo';
  }
  buildCounterGoogleIamV1AuditLogConfig--;
  return o;
...
void checkGoogleIamV1AuditLogConfig(api.GoogleIamV1AuditLogConfig o) {
  buildCounterGoogleIamV1AuditLogConfig++;
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    checkUnnamed8329(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleIamV1AuditConfig> buildUnnamed8331() {
  var o = <api.GoogleIamV1AuditConfig>[];
...
void checkUnnamed8331(core.List<api.GoogleIamV1AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleIamV1Binding> buildUnnamed8332() {
  var o = <api.GoogleIamV1Binding>[];
...
void checkUnnamed8332(core.List<api.GoogleIamV1Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleIamV1Policy buildGoogleIamV1Policy() {
  ...
  if (buildCounterGoogleIamV1Policy < 3) {
    o.auditConfigs = buildUnnamed8331();
    o.bindings = buildUnnamed8332();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterGoogleIamV1Policy--;
...
void checkGoogleIamV1Policy(api.GoogleIamV1Policy o) {
  buildCounterGoogleIamV1Policy++;
  if (buildCounterGoogleIamV1Policy < 3) {
    checkUnnamed8331(o.auditConfigs!);
    checkUnnamed8332(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleLongrunningOperation> buildUnnamed8333() {
...
void checkUnnamed8333(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed8336() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed8336(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8337() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed8336());
  o.add(buildUnnamed8336());
  return o;
}

void checkUnnamed8337(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8336(o[0]);
  checkUnnamed8336(o[1]);
}
