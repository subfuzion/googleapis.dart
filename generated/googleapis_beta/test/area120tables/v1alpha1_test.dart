...
core.List<api.CreateRowRequest> buildUnnamed8468() {
...
void checkUnnamed8468(core.List<api.CreateRowRequest> o) {
...
void checkBatchCreateRowsRequest(api.BatchCreateRowsRequest o) {
  buildCounterBatchCreateRowsRequest++;
  if (buildCounterBatchCreateRowsRequest < 3) {
    checkUnnamed8468(o.requests!);
  }
  buildCounterBatchCreateRowsRequest--;
}

core.List<api.Row> buildUnnamed8469() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8469(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchDeleteRowsRequest(api.BatchDeleteRowsRequest o) {
  buildCounterBatchDeleteRowsRequest++;
  if (buildCounterBatchDeleteRowsRequest < 3) {
    checkUnnamed8470(o.names!);
  }
  buildCounterBatchDeleteRowsRequest--;
}

core.List<api.UpdateRowRequest> buildUnnamed8471() {
...
void checkUnnamed8471(core.List<api.UpdateRowRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Row> buildUnnamed8472() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8472(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}
...
void checkBatchUpdateRowsResponse(api.BatchUpdateRowsResponse o) {
  buildCounterBatchUpdateRowsResponse++;
  if (buildCounterBatchUpdateRowsResponse < 3) {
    checkUnnamed8472(o.rows!);
  }
  buildCounterBatchUpdateRowsResponse--;
}

core.List<api.LabeledItem> buildUnnamed8473() {
...
void checkUnnamed8473(core.List<api.LabeledItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Row> buildUnnamed8474() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed8474(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRow(o[0] as api.Row);
  checkRow(o[1] as api.Row);
}
...
void checkListRowsResponse(api.ListRowsResponse o) {
  ...
  if (buildCounterListRowsResponse < 3) {
    ...
    checkUnnamed8474(o.rows!);
  }
  buildCounterListRowsResponse--;
}

core.List<api.Table> buildUnnamed8475() {
  var o = <api.Table>[];
  o.add(buildTable());
  o.add(buildTable());
  return o;
...
void checkUnnamed8475(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListTablesResponse(api.ListTablesResponse o) {
  ...
  if (buildCounterListTablesResponse < 3) {
    ...
    checkUnnamed8475(o.tables!);
  }
  buildCounterListTablesResponse--;
}

core.List<api.Workspace> buildUnnamed8476() {
  var o = <api.Workspace>[];
...
void checkUnnamed8476(core.List<api.Workspace> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed8477() {
...
void checkUnnamed8477(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ColumnDescription> buildUnnamed8478() {
  var o = <api.ColumnDescription>[];
...
void checkUnnamed8479(core.List<api.SavedView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Table buildTable() {
  ...
  if (buildCounterTable < 3) {
    o.columns = buildUnnamed8478();
    o.createTime = 'foo';
    o.displayName = 'foo';
    o.name = 'foo';
    o.savedViews = buildUnnamed8479();
    o.updateTime = 'foo';
  }
  buildCounterTable--;
  return o;
...
core.List<api.Table> buildUnnamed8480() {
  var o = <api.Table>[];
  o.add(buildTable());
  o.add(buildTable());
  return o;
...
void checkUnnamed8480(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0] as api.Table);
  checkTable(o[1] as api.Table);
}
