...
core.List<api.SourceReference> buildUnnamed8240() {
...
void checkUnnamed8240(core.List<api.SourceReference> o) {
...
api.ErrorContext buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed8240();
    o.user = 'foo';
  }
  buildCounterErrorContext--;
  return o;
...
void checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed8240(o.sourceReferences!);
    unittest.expect(
      o.user!,
      unittest.equals('foo'),
    );
...
core.List<api.TrackingIssue> buildUnnamed8241() {
...
void checkUnnamed8241(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ErrorGroup buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    o.trackingIssues = buildUnnamed8241();
  }
  buildCounterErrorGroup--;
  return o;
}
...
void checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed8241(o.trackingIssues!);
  }
  buildCounterErrorGroup--;
}

core.List<api.ServiceContext> buildUnnamed8242() {
...
void checkUnnamed8242(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceContext(o[0] as api.ServiceContext);
  checkServiceContext(o[1] as api.ServiceContext);
}

core.List<api.TimedCount> buildUnnamed8243() {
...
void checkUnnamed8243(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ErrorGroupStats buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed8242();
    ...
    o.timedCounts = buildUnnamed8243();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
void checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed8242(o.affectedServices!);
    unittest.expect(
    ...
    checkUnnamed8243(o.timedCounts!);
  }
  buildCounterErrorGroupStats--;
}
...
core.List<api.ErrorEvent> buildUnnamed8244() {
  var o = <api.ErrorEvent>[];
...
void checkUnnamed8244(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEventsResponse buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed8244();
    o.nextPageToken = 'foo';
...
void checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed8244(o.errorEvents!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.ErrorGroupStats> buildUnnamed8245() {
  var o = <api.ErrorGroupStats>[];
...
void checkUnnamed8245(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGroupStatsResponse buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed8245();
    o.nextPageToken = 'foo';
    o.timeRangeBegin = 'foo';
  }
  buildCounterListGroupStatsResponse--;
...
void checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed8245(o.errorGroupStats!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-ProjectsGroupStatsResource', () {
    unittest.test('method--list', () async {
      ...
      var arg_groupId = buildUnnamed8246();
      var arg_order = 'foo';
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_serviceFilter_resourceType = 'foo';
